...
#
#    python3 Tests/user_data_guard.py            # from plugins/Terrain
...
#
#
#  ⚠️ fb605 — "TerrainInstrument" AND "Terrain Instrument" BELOW ARE ON PURPOSE. The product was
#     renamed to **Terrain** this build (dir, targets, bundle, UI). THESE ARE NOT NAMES, THEY ARE
#     ADDRESSES: ~/Library/WavesCrate/TerrainInstrument/ holds the owner's 29 card presets, 67 MB
#     of Noise and 32 MB of Blends, and ~/Library/Noizefield/Terrain Instrument/ holds his user
#     patches and Wavetables. Repointing either STRANDS all of it. Same class as the GEODE param
#     ids: rename the class, the files and the UI — never the thing already written to disk. If a
#     future build ever does move them, it moves them WITH A MIGRATION, and this gate is what
