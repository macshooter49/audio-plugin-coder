...
//    ⚠️ fb605 — "TerrainInstrument" in the path below is the owner's 67 MB Noise library ON DISK,
//       not the product name (which is "Terrain" now). It is an address. Do not rename it here.
