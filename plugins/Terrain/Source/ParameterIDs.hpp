...
namespace ParameterIDs
{
    ...
    // See plugins/Terrain/Design/v1-syn-spec.md for the full
    ...
    constexpr char SYN_OSC_A_PHASE[]     = "SYN_OSC_A_PHASE";      // float 0..1 CYCLES (fb538), def 0.5 = 180° (fb631)
    ...
    constexpr char SYN_OSC_B_PHASE[]     = "SYN_OSC_B_PHASE";      // float 0..1 CYCLES (fb538), def 0.5 = 180° (fb631)
    ...
    constexpr char SYN_OSC_C_PHASE[]     = "SYN_OSC_C_PHASE";      // float 0..1 CYCLES (fb538), def 0.5 = 180° (fb631)
    ...
    constexpr char SYN_OSC_D_PHASE[]     = "SYN_OSC_D_PHASE";      // float 0..1 CYCLES (fb538), def 0.5 = 180° (fb631)
    ...
    // ════════ RESYNTH-ENGINE-PARAMS — per-OSC RESYNTH oscillator (Engine::SPEC) ════════
    //
    //  ⛔⛔ fb605 — STOP. DO NOT RENAME THE "GEODE" IN THE ID STRINGS BELOW. ⛔⛔
    //
    //  The engine formerly called "Geode" is now called RESYNTH everywhere — the class
    //  (tw::ResynthEngine), the namespace (tw::resynth), the file (Source/ResynthEngine.h),
    //  the cert seams (RESYNTH_*), the menus and the labels. The rename is FINISHED.
    //  These ID strings are the ONE deliberate exception, and they are exempt FOREVER.
    //
    //  A parameter ID is not a name, it is the ON-DISK KEY. JUCE writes these exact strings
    //  into every saved patch, every DAW project's plugin state and every automation lane.
    //  Rewriting "SYN_OSC_A_GEODE_HAZE" as "SYN_OSC_A_RESYNTH_HAZE" makes the host look up a
    //  parameter that no longer exists: the stored value is dropped on load and the automation
    //  lane goes dead — SILENTLY, in work that already shipped. It looks like tidying and it
    //  is data loss. If you ever genuinely must change them, that is a state-migration task
    //  (read the old key, write the new one, keep the alias) — never a search-and-replace.
    //
    // Own namespace — MUST NOT collide with SYN_OSC_x_SPECTRAL_TYPE/AMT (the spectral FILTER).
    // Meaning is REMAPPED (see PluginProcessor gather): CREEP=Scan, FOSSIL=Stretch,
    ...
    // ── tp104 — THE ORGANICS ENGINE (Engine::ORGANIC = 7): INST/ARTIC ints + ten 0..1 knobs per osc (contract §4) ──
    constexpr char SYN_OSC_A_ORG_INST[] = "SYN_OSC_A_ORG_INST";
    constexpr char SYN_OSC_A_ORG_ARTIC[] = "SYN_OSC_A_ORG_ARTIC";
    constexpr char SYN_OSC_A_ORG_DYNAMICS[] = "SYN_OSC_A_ORG_DYNAMICS";
    constexpr char SYN_OSC_A_ORG_TONE[] = "SYN_OSC_A_ORG_TONE";
    constexpr char SYN_OSC_A_ORG_BODY[] = "SYN_OSC_A_ORG_BODY";
    constexpr char SYN_OSC_A_ORG_ATTACK[] = "SYN_OSC_A_ORG_ATTACK";
    constexpr char SYN_OSC_A_ORG_HUMAN[] = "SYN_OSC_A_ORG_HUMAN";
    constexpr char SYN_OSC_A_ORG_RELEASE[] = "SYN_OSC_A_ORG_RELEASE";
    constexpr char SYN_OSC_A_ORG_NOISE[] = "SYN_OSC_A_ORG_NOISE";
    ...
    constexpr char SYN_OSC_B_ORG_INST[] = "SYN_OSC_B_ORG_INST";
    constexpr char SYN_OSC_B_ORG_ARTIC[] = "SYN_OSC_B_ORG_ARTIC";
    constexpr char SYN_OSC_B_ORG_DYNAMICS[] = "SYN_OSC_B_ORG_DYNAMICS";
    constexpr char SYN_OSC_B_ORG_TONE[] = "SYN_OSC_B_ORG_TONE";
    constexpr char SYN_OSC_B_ORG_BODY[] = "SYN_OSC_B_ORG_BODY";
    constexpr char SYN_OSC_B_ORG_ATTACK[] = "SYN_OSC_B_ORG_ATTACK";
    constexpr char SYN_OSC_B_ORG_HUMAN[] = "SYN_OSC_B_ORG_HUMAN";
    constexpr char SYN_OSC_B_ORG_RELEASE[] = "SYN_OSC_B_ORG_RELEASE";
    constexpr char SYN_OSC_B_ORG_NOISE[] = "SYN_OSC_B_ORG_NOISE";
    ...
    constexpr char SYN_OSC_C_ORG_INST[] = "SYN_OSC_C_ORG_INST";
    constexpr char SYN_OSC_C_ORG_ARTIC[] = "SYN_OSC_C_ORG_ARTIC";
    constexpr char SYN_OSC_C_ORG_DYNAMICS[] = "SYN_OSC_C_ORG_DYNAMICS";
    constexpr char SYN_OSC_C_ORG_TONE[] = "SYN_OSC_C_ORG_TONE";
    constexpr char SYN_OSC_C_ORG_BODY[] = "SYN_OSC_C_ORG_BODY";
    constexpr char SYN_OSC_C_ORG_ATTACK[] = "SYN_OSC_C_ORG_ATTACK";
    constexpr char SYN_OSC_C_ORG_HUMAN[] = "SYN_OSC_C_ORG_HUMAN";
    constexpr char SYN_OSC_C_ORG_RELEASE[] = "SYN_OSC_C_ORG_RELEASE";
    constexpr char SYN_OSC_C_ORG_NOISE[] = "SYN_OSC_C_ORG_NOISE";
    ...
    constexpr char SYN_OSC_D_ORG_INST[] = "SYN_OSC_D_ORG_INST";
    constexpr char SYN_OSC_D_ORG_ARTIC[] = "SYN_OSC_D_ORG_ARTIC";
    constexpr char SYN_OSC_D_ORG_DYNAMICS[] = "SYN_OSC_D_ORG_DYNAMICS";
    constexpr char SYN_OSC_D_ORG_TONE[] = "SYN_OSC_D_ORG_TONE";
    constexpr char SYN_OSC_D_ORG_BODY[] = "SYN_OSC_D_ORG_BODY";
    constexpr char SYN_OSC_D_ORG_ATTACK[] = "SYN_OSC_D_ORG_ATTACK";
    constexpr char SYN_OSC_D_ORG_HUMAN[] = "SYN_OSC_D_ORG_HUMAN";
    constexpr char SYN_OSC_D_ORG_RELEASE[] = "SYN_OSC_D_ORG_RELEASE";
    constexpr char SYN_OSC_D_ORG_NOISE[] = "SYN_OSC_D_ORG_NOISE";
    ...
    // ══ tp20 — THE OSCILLATOR POOL, BANK 2 (E–H). GENERATED from the A set by scripts/gen_osc_bank_ids.py —
    ...
    // ── OSC E ──
    constexpr char SYN_OSC_E_ENGINE[] = "SYN_OSC_E_ENGINE";
    constexpr char SYN_OSC_E_OCT[] = "SYN_OSC_E_OCT";
    constexpr char SYN_OSC_E_SEMI[] = "SYN_OSC_E_SEMI";
    constexpr char SYN_OSC_E_CENT[] = "SYN_OSC_E_CENT";
    constexpr char SYN_OSC_E_LEVEL[] = "SYN_OSC_E_LEVEL";
    constexpr char SYN_OSC_E_PAN[] = "SYN_OSC_E_PAN";
    constexpr char SYN_OSC_E_ENABLE[] = "SYN_OSC_E_ENABLE";
    constexpr char SYN_OSC_E_MUTE[] = "SYN_OSC_E_MUTE";
    constexpr char SYN_OSC_E_SOLO[] = "SYN_OSC_E_SOLO";
    constexpr char SYN_OSC_E_F1MIX[] = "SYN_OSC_E_F1MIX";
    constexpr char SYN_OSC_E_F2MIX[] = "SYN_OSC_E_F2MIX";
    constexpr char SYN_OSC_E_WT_PRESET[] = "SYN_OSC_E_WT_PRESET";
    constexpr char SYN_OSC_E_WT_FRAME[] = "SYN_OSC_E_WT_FRAME";
    constexpr char SYN_OSC_E_WARP_MODE[] = "SYN_OSC_E_WARP_MODE";
    constexpr char SYN_OSC_E_WARP_AMOUNT[] = "SYN_OSC_E_WARP_AMOUNT";
    constexpr char SYN_OSC_E_WARP2_MODE[] = "SYN_OSC_E_WARP2_MODE";
    constexpr char SYN_OSC_E_WARP2_AMT[] = "SYN_OSC_E_WARP2_AMT";
    constexpr char SYN_OSC_E_SPECTRAL_TYPE[] = "SYN_OSC_E_SPECTRAL_TYPE";
    constexpr char SYN_OSC_E_SPECTRAL_AMT[] = "SYN_OSC_E_SPECTRAL_AMT";
    constexpr char SYN_OSC_E_SPECTRAL_LO[] = "SYN_OSC_E_SPECTRAL_LO";
    constexpr char SYN_OSC_E_SPECTRAL_HI[] = "SYN_OSC_E_SPECTRAL_HI";
    constexpr char SYN_OSC_E_FOLD_SHAPE[] = "SYN_OSC_E_FOLD_SHAPE";
    constexpr char SYN_OSC_E_FOLD_AMT[] = "SYN_OSC_E_FOLD_AMT";
    constexpr char SYN_OSC_E_FRAME_SPREAD[] = "SYN_OSC_E_FRAME_SPREAD";
    constexpr char SYN_OSC_E_INTERP_MODE[] = "SYN_OSC_E_INTERP_MODE";
    constexpr char SYN_OSC_E_PHASE_MODE[] = "SYN_OSC_E_PHASE_MODE";
    constexpr char SYN_OSC_E_WAVER[] = "SYN_OSC_E_WAVER";
    constexpr char SYN_OSC_E_KEYTRACK[] = "SYN_OSC_E_KEYTRACK";
    constexpr char SYN_OSC_E_KEYTRACK_DEST[] = "SYN_OSC_E_KEYTRACK_DEST";
    constexpr char SYN_OSC_E_ROUTE_SRC[] = "SYN_OSC_E_ROUTE_SRC";
    constexpr char SYN_OSC_E_ROUTE_DEST[] = "SYN_OSC_E_ROUTE_DEST";
    constexpr char SYN_OSC_E_ROUTE_AMT[] = "SYN_OSC_E_ROUTE_AMT";
    constexpr char SYN_OSC_E_UNISON[] = "SYN_OSC_E_UNISON";
    constexpr char SYN_OSC_E_UDETUNE[] = "SYN_OSC_E_UDETUNE";
    constexpr char SYN_OSC_E_UBLEND[] = "SYN_OSC_E_UBLEND";
    constexpr char SYN_OSC_E_UWIDTH[] = "SYN_OSC_E_UWIDTH";
    constexpr char SYN_OSC_E_URANGE[] = "SYN_OSC_E_URANGE";
    constexpr char SYN_OSC_E_UWARP[] = "SYN_OSC_E_UWARP";
    constexpr char SYN_OSC_E_USTACK[] = "SYN_OSC_E_USTACK";
    constexpr char SYN_OSC_E_WVAR[] = "SYN_OSC_E_WVAR";
    constexpr char SYN_OSC_E_W2VAR[] = "SYN_OSC_E_W2VAR";
    constexpr char SYN_OSC_E_PHASE[] = "SYN_OSC_E_PHASE";
    constexpr char SYN_OSC_E_PHASE_AMT[] = "SYN_OSC_E_PHASE_AMT";
    constexpr char SYN_OSC_E_SAMPLE_SCAN[] = "SYN_OSC_E_SAMPLE_SCAN";
    constexpr char SYN_OSC_E_SAMPLE_STRETCH[] = "SYN_OSC_E_SAMPLE_STRETCH";
    constexpr char SYN_OSC_E_SAMPLE_FORMANT[] = "SYN_OSC_E_SAMPLE_FORMANT";
    constexpr char SYN_OSC_E_SAMPLE_SPRAY[] = "SYN_OSC_E_SAMPLE_SPRAY";
    constexpr char SYN_OSC_E_SAMPLE_XFADE[] = "SYN_OSC_E_SAMPLE_XFADE";
    constexpr char SYN_OSC_E_SAMPLE_START[] = "SYN_OSC_E_SAMPLE_START";
    constexpr char SYN_OSC_E_SAMPLE_END[] = "SYN_OSC_E_SAMPLE_END";
    constexpr char SYN_OSC_E_SAMPLE_LOOP_START[] = "SYN_OSC_E_SAMPLE_LOOP_START";
    constexpr char SYN_OSC_E_SAMPLE_LOOP_END[] = "SYN_OSC_E_SAMPLE_LOOP_END";
    constexpr char SYN_OSC_E_SAMPLE_LOOP_MODE[] = "SYN_OSC_E_SAMPLE_LOOP_MODE";
    constexpr char SYN_OSC_E_SAMPLE_SNAP[] = "SYN_OSC_E_SAMPLE_SNAP";
    constexpr char SYN_OSC_E_SAMPLE_STRETCH_MODE[] = "SYN_OSC_E_SAMPLE_STRETCH_MODE";
    constexpr char SYN_OSC_E_SAMPLE_FORMANT_MODE[] = "SYN_OSC_E_SAMPLE_FORMANT_MODE";
    constexpr char SYN_OSC_E_SAMPLE_FADE_IN[] = "SYN_OSC_E_SAMPLE_FADE_IN";
    constexpr char SYN_OSC_E_SAMPLE_FADE_OUT[] = "SYN_OSC_E_SAMPLE_FADE_OUT";
    constexpr char SYN_OSC_E_SAMPLE_AIR[] = "SYN_OSC_E_SAMPLE_AIR";
    constexpr char SYN_OSC_E_SAMPLE_WARP[] = "SYN_OSC_E_SAMPLE_WARP";
    constexpr char SYN_OSC_E_SAMPLE_WARPMODE[] = "SYN_OSC_E_SAMPLE_WARPMODE";
    constexpr char SYN_OSC_E_GRAIN_SCAN[] = "SYN_OSC_E_GRAIN_SCAN";
    constexpr char SYN_OSC_E_GRAIN_DENSITY[] = "SYN_OSC_E_GRAIN_DENSITY";
    constexpr char SYN_OSC_E_GRAIN_SIZE[] = "SYN_OSC_E_GRAIN_SIZE";
    constexpr char SYN_OSC_E_GRAIN_SPRAY[] = "SYN_OSC_E_GRAIN_SPRAY";
    constexpr char SYN_OSC_E_GRAIN_SHAPE[] = "SYN_OSC_E_GRAIN_SHAPE";
    constexpr char SYN_OSC_E_GRAIN_KEY[] = "SYN_OSC_E_GRAIN_KEY";
    constexpr char SYN_OSC_E_BLEND_MORPH[] = "SYN_OSC_E_BLEND_MORPH";
    constexpr char SYN_OSC_E_BLEND_ATTACK[] = "SYN_OSC_E_BLEND_ATTACK";
    constexpr char SYN_OSC_E_BLEND_BODY[] = "SYN_OSC_E_BLEND_BODY";
    constexpr char SYN_OSC_E_BLEND_BREATH[] = "SYN_OSC_E_BLEND_BREATH";
    constexpr char SYN_OSC_E_BLEND_SCULPT[] = "SYN_OSC_E_BLEND_SCULPT";
    constexpr char SYN_OSC_E_BLEND_DICE[] = "SYN_OSC_E_BLEND_DICE";
    constexpr char SYN_OSC_E_SAMPLE_FADEIN_CURVE[] = "SYN_OSC_E_SAMPLE_FADEIN_CURVE";
    constexpr char SYN_OSC_E_SAMPLE_FADEOUT_CURVE[] = "SYN_OSC_E_SAMPLE_FADEOUT_CURVE";
    constexpr char SYN_OSC_E_GRAIN_POSITION[] = "SYN_OSC_E_GRAIN_POSITION";
    constexpr char SYN_OSC_E_GRAIN_PITCH[] = "SYN_OSC_E_GRAIN_PITCH";
    constexpr char SYN_OSC_E_GRAIN_PSPRAY[] = "SYN_OSC_E_GRAIN_PSPRAY";
    constexpr char SYN_OSC_E_GRAIN_WIDTH[] = "SYN_OSC_E_GRAIN_WIDTH";
    constexpr char SYN_OSC_E_GRAIN_DIR[] = "SYN_OSC_E_GRAIN_DIR";
    constexpr char SYN_OSC_E_GRAIN_SKEW[] = "SYN_OSC_E_GRAIN_SKEW";
    constexpr char SYN_OSC_E_FM_ALGO[] = "SYN_OSC_E_FM_ALGO";
    constexpr char SYN_OSC_E_FM_RATIO1[] = "SYN_OSC_E_FM_RATIO1";
    constexpr char SYN_OSC_E_FM_DEPTH1[] = "SYN_OSC_E_FM_DEPTH1";
    constexpr char SYN_OSC_E_FM_RATIO2[] = "SYN_OSC_E_FM_RATIO2";
    constexpr char SYN_OSC_E_FM_DEPTH2[] = "SYN_OSC_E_FM_DEPTH2";
    constexpr char SYN_OSC_E_FM_FB[] = "SYN_OSC_E_FM_FB";
    constexpr char SYN_OSC_E_FM_STRIKE[] = "SYN_OSC_E_FM_STRIKE";
    constexpr char SYN_OSC_E_FM_AGE[] = "SYN_OSC_E_FM_AGE";
    constexpr char SYN_OSC_E_FM_RUST[] = "SYN_OSC_E_FM_RUST";
    constexpr char SYN_OSC_E_FM_GALE[] = "SYN_OSC_E_FM_GALE";
    constexpr char SYN_OSC_E_FM_BEND[] = "SYN_OSC_E_FM_BEND";
    constexpr char SYN_OSC_E_FM_STORM[] = "SYN_OSC_E_FM_STORM";
    constexpr char SYN_OSC_E_GEODE_POSITION[] = "SYN_OSC_E_GEODE_POSITION";
    constexpr char SYN_OSC_E_GEODE_FOSSIL[] = "SYN_OSC_E_GEODE_FOSSIL";
    constexpr char SYN_OSC_E_GEODE_CREEP[] = "SYN_OSC_E_GEODE_CREEP";
    constexpr char SYN_OSC_E_GEODE_SILT[] = "SYN_OSC_E_GEODE_SILT";
    constexpr char SYN_OSC_E_GEODE_FORMANT[] = "SYN_OSC_E_GEODE_FORMANT";
    constexpr char SYN_OSC_E_GEODE_CUT[] = "SYN_OSC_E_GEODE_CUT";
    constexpr char SYN_OSC_E_GEODE_SIEVE[] = "SYN_OSC_E_GEODE_SIEVE";
    constexpr char SYN_OSC_E_GEODE_DISTILL[] = "SYN_OSC_E_GEODE_DISTILL";
    constexpr char SYN_OSC_E_GEODE_HAZE[] = "SYN_OSC_E_GEODE_HAZE";
    constexpr char SYN_OSC_E_GEODE_FRACTURE[] = "SYN_OSC_E_GEODE_FRACTURE";
    constexpr char SYN_OSC_E_GEODE_TILT[] = "SYN_OSC_E_GEODE_TILT";
    constexpr char SYN_OSC_E_GEODE_QUALITY[] = "SYN_OSC_E_GEODE_QUALITY";
    constexpr char SYN_OSC_E_GEODE_FKEEP[] = "SYN_OSC_E_GEODE_FKEEP";
    constexpr char SYN_OSC_E_GEODE_LOOP[] = "SYN_OSC_E_GEODE_LOOP";
    constexpr char SYN_OSC_E_GEODE_BEDROCK[] = "SYN_OSC_E_GEODE_BEDROCK";
    constexpr char SYN_OSC_E_GEODE_SHAPE_TARGET[] = "SYN_OSC_E_GEODE_SHAPE_TARGET";
    constexpr char SYN_OSC_E_GEODE_CUT_MODE[] = "SYN_OSC_E_GEODE_CUT_MODE";
    constexpr char SYN_OSC_E_GEODE_DRIVE_MODE[] = "SYN_OSC_E_GEODE_DRIVE_MODE";
    constexpr char SYN_OSC_E_GEODE_SIEVE_MODE[] = "SYN_OSC_E_GEODE_SIEVE_MODE";
    constexpr char SYN_OSC_E_HARM_MODE[] = "SYN_OSC_E_HARM_MODE";
    constexpr char SYN_OSC_E_HARM_SCULPT[] = "SYN_OSC_E_HARM_SCULPT";
    constexpr char SYN_OSC_E_HARM_HUE[] = "SYN_OSC_E_HARM_HUE";
    constexpr char SYN_OSC_E_HARM_COUNT[] = "SYN_OSC_E_HARM_COUNT";
    constexpr char SYN_OSC_E_HARM_LEAN[] = "SYN_OSC_E_HARM_LEAN";
    constexpr char SYN_OSC_E_HARM_FAN[] = "SYN_OSC_E_HARM_FAN";
    constexpr char SYN_OSC_E_HARM_GRIT[] = "SYN_OSC_E_HARM_GRIT";
    constexpr char SYN_OSC_E_HARM_BRAID[] = "SYN_OSC_E_HARM_BRAID";
    constexpr char SYN_OSC_E_HARM_CARVE[] = "SYN_OSC_E_HARM_CARVE";
    constexpr char SYN_OSC_E_HARM_CHURN[] = "SYN_OSC_E_HARM_CHURN";
    constexpr char SYN_OSC_E_HARM_ROOT[] = "SYN_OSC_E_HARM_ROOT";
    constexpr char SYN_OSC_E_HARM_SHINE[] = "SYN_OSC_E_HARM_SHINE";
    constexpr char SYN_OSC_E_HARM_WILT[] = "SYN_OSC_E_HARM_WILT";
    constexpr char SYN_OSC_E_HARM_FIZZ[] = "SYN_OSC_E_HARM_FIZZ";
    constexpr char SYN_OSC_E_HARM_TABLE[] = "SYN_OSC_E_HARM_TABLE";
    constexpr char SYN_OSC_E_COARSE[] = "SYN_OSC_E_COARSE";
    constexpr char SYN_OSC_E_SUB_RANGE[] = "SYN_OSC_E_SUB_RANGE";
    constexpr char SYN_OSC_E_SUB_FORM[] = "SYN_OSC_E_SUB_FORM";
    constexpr char SYN_OSC_E_SUB_WEIGHT[] = "SYN_OSC_E_SUB_WEIGHT";
    constexpr char SYN_OSC_E_SUB_HEAT[] = "SYN_OSC_E_SUB_HEAT";
    constexpr char SYN_OSC_E_MODAL_FAMILY[] = "SYN_OSC_E_MODAL_FAMILY";
    constexpr char SYN_OSC_E_MODAL_FORM[] = "SYN_OSC_E_MODAL_FORM";
    constexpr char SYN_OSC_E_MODAL_SOURCE[] = "SYN_OSC_E_MODAL_SOURCE";
    constexpr char SYN_OSC_E_MODAL_HARD[] = "SYN_OSC_E_MODAL_HARD";
    constexpr char SYN_OSC_E_MODAL_POS[] = "SYN_OSC_E_MODAL_POS";
    constexpr char SYN_OSC_E_MODAL_DECAY[] = "SYN_OSC_E_MODAL_DECAY";
    constexpr char SYN_OSC_E_MODAL_MATERIAL[] = "SYN_OSC_E_MODAL_MATERIAL";
    constexpr char SYN_OSC_E_MODAL_BREATH[] = "SYN_OSC_E_MODAL_BREATH";
    constexpr char SYN_OSC_E_MODAL_STRETCH[] = "SYN_OSC_E_MODAL_STRETCH";
    constexpr char SYN_OSC_E_MODAL_BLOOM[] = "SYN_OSC_E_MODAL_BLOOM";
    constexpr char SYN_OSC_E_MODAL_HALO[] = "SYN_OSC_E_MODAL_HALO";
    constexpr char SYN_OSC_E_MODAL_AGE[] = "SYN_OSC_E_MODAL_AGE";
    constexpr char SYN_OSC_E_MODAL_BODY[] = "SYN_OSC_E_MODAL_BODY";
    constexpr char SYN_OSC_E_ORG_INST[] = "SYN_OSC_E_ORG_INST";
    constexpr char SYN_OSC_E_ORG_ARTIC[] = "SYN_OSC_E_ORG_ARTIC";
    constexpr char SYN_OSC_E_ORG_DYNAMICS[] = "SYN_OSC_E_ORG_DYNAMICS";
    constexpr char SYN_OSC_E_ORG_TONE[] = "SYN_OSC_E_ORG_TONE";
    constexpr char SYN_OSC_E_ORG_BODY[] = "SYN_OSC_E_ORG_BODY";
    constexpr char SYN_OSC_E_ORG_ATTACK[] = "SYN_OSC_E_ORG_ATTACK";
    constexpr char SYN_OSC_E_ORG_HUMAN[] = "SYN_OSC_E_ORG_HUMAN";
    constexpr char SYN_OSC_E_ORG_RELEASE[] = "SYN_OSC_E_ORG_RELEASE";
    constexpr char SYN_OSC_E_ORG_NOISE[] = "SYN_OSC_E_ORG_NOISE";
    ...
    constexpr char SYN_OSC_E_WSLOT2_MODE[] = "SYN_OSC_E_WSLOT2_MODE";
    constexpr char SYN_OSC_E_WSLOT2_SRC[] = "SYN_OSC_E_WSLOT2_SRC";
    constexpr char SYN_OSC_E_WSLOT2_DEPTH[] = "SYN_OSC_E_WSLOT2_DEPTH";
    constexpr char SYN_OSC_E_WSLOT3_MODE[] = "SYN_OSC_E_WSLOT3_MODE";
    constexpr char SYN_OSC_E_WSLOT3_SRC[] = "SYN_OSC_E_WSLOT3_SRC";
    constexpr char SYN_OSC_E_WSLOT3_DEPTH[] = "SYN_OSC_E_WSLOT3_DEPTH";
    constexpr char SYN_OSC_E_WSLOT4_MODE[] = "SYN_OSC_E_WSLOT4_MODE";
    constexpr char SYN_OSC_E_WSLOT4_SRC[] = "SYN_OSC_E_WSLOT4_SRC";
    constexpr char SYN_OSC_E_WSLOT4_DEPTH[] = "SYN_OSC_E_WSLOT4_DEPTH";
    // ── OSC F ──
    constexpr char SYN_OSC_F_ENGINE[] = "SYN_OSC_F_ENGINE";
    constexpr char SYN_OSC_F_OCT[] = "SYN_OSC_F_OCT";
    constexpr char SYN_OSC_F_SEMI[] = "SYN_OSC_F_SEMI";
    constexpr char SYN_OSC_F_CENT[] = "SYN_OSC_F_CENT";
    constexpr char SYN_OSC_F_LEVEL[] = "SYN_OSC_F_LEVEL";
    constexpr char SYN_OSC_F_PAN[] = "SYN_OSC_F_PAN";
    constexpr char SYN_OSC_F_ENABLE[] = "SYN_OSC_F_ENABLE";
    constexpr char SYN_OSC_F_MUTE[] = "SYN_OSC_F_MUTE";
    constexpr char SYN_OSC_F_SOLO[] = "SYN_OSC_F_SOLO";
    constexpr char SYN_OSC_F_F1MIX[] = "SYN_OSC_F_F1MIX";
    constexpr char SYN_OSC_F_F2MIX[] = "SYN_OSC_F_F2MIX";
    constexpr char SYN_OSC_F_WT_PRESET[] = "SYN_OSC_F_WT_PRESET";
    constexpr char SYN_OSC_F_WT_FRAME[] = "SYN_OSC_F_WT_FRAME";
    constexpr char SYN_OSC_F_WARP_MODE[] = "SYN_OSC_F_WARP_MODE";
    constexpr char SYN_OSC_F_WARP_AMOUNT[] = "SYN_OSC_F_WARP_AMOUNT";
    constexpr char SYN_OSC_F_WARP2_MODE[] = "SYN_OSC_F_WARP2_MODE";
    constexpr char SYN_OSC_F_WARP2_AMT[] = "SYN_OSC_F_WARP2_AMT";
    constexpr char SYN_OSC_F_SPECTRAL_TYPE[] = "SYN_OSC_F_SPECTRAL_TYPE";
    constexpr char SYN_OSC_F_SPECTRAL_AMT[] = "SYN_OSC_F_SPECTRAL_AMT";
    constexpr char SYN_OSC_F_SPECTRAL_LO[] = "SYN_OSC_F_SPECTRAL_LO";
    constexpr char SYN_OSC_F_SPECTRAL_HI[] = "SYN_OSC_F_SPECTRAL_HI";
    constexpr char SYN_OSC_F_FOLD_SHAPE[] = "SYN_OSC_F_FOLD_SHAPE";
    constexpr char SYN_OSC_F_FOLD_AMT[] = "SYN_OSC_F_FOLD_AMT";
    constexpr char SYN_OSC_F_FRAME_SPREAD[] = "SYN_OSC_F_FRAME_SPREAD";
    constexpr char SYN_OSC_F_INTERP_MODE[] = "SYN_OSC_F_INTERP_MODE";
    constexpr char SYN_OSC_F_PHASE_MODE[] = "SYN_OSC_F_PHASE_MODE";
    constexpr char SYN_OSC_F_WAVER[] = "SYN_OSC_F_WAVER";
    constexpr char SYN_OSC_F_KEYTRACK[] = "SYN_OSC_F_KEYTRACK";
    constexpr char SYN_OSC_F_KEYTRACK_DEST[] = "SYN_OSC_F_KEYTRACK_DEST";
    constexpr char SYN_OSC_F_ROUTE_SRC[] = "SYN_OSC_F_ROUTE_SRC";
    constexpr char SYN_OSC_F_ROUTE_DEST[] = "SYN_OSC_F_ROUTE_DEST";
    constexpr char SYN_OSC_F_ROUTE_AMT[] = "SYN_OSC_F_ROUTE_AMT";
    constexpr char SYN_OSC_F_UNISON[] = "SYN_OSC_F_UNISON";
    constexpr char SYN_OSC_F_UDETUNE[] = "SYN_OSC_F_UDETUNE";
    constexpr char SYN_OSC_F_UBLEND[] = "SYN_OSC_F_UBLEND";
    constexpr char SYN_OSC_F_UWIDTH[] = "SYN_OSC_F_UWIDTH";
    constexpr char SYN_OSC_F_URANGE[] = "SYN_OSC_F_URANGE";
    constexpr char SYN_OSC_F_UWARP[] = "SYN_OSC_F_UWARP";
    constexpr char SYN_OSC_F_USTACK[] = "SYN_OSC_F_USTACK";
    constexpr char SYN_OSC_F_WVAR[] = "SYN_OSC_F_WVAR";
    constexpr char SYN_OSC_F_W2VAR[] = "SYN_OSC_F_W2VAR";
    constexpr char SYN_OSC_F_PHASE[] = "SYN_OSC_F_PHASE";
    constexpr char SYN_OSC_F_PHASE_AMT[] = "SYN_OSC_F_PHASE_AMT";
    constexpr char SYN_OSC_F_SAMPLE_SCAN[] = "SYN_OSC_F_SAMPLE_SCAN";
    constexpr char SYN_OSC_F_SAMPLE_STRETCH[] = "SYN_OSC_F_SAMPLE_STRETCH";
    constexpr char SYN_OSC_F_SAMPLE_FORMANT[] = "SYN_OSC_F_SAMPLE_FORMANT";
    constexpr char SYN_OSC_F_SAMPLE_SPRAY[] = "SYN_OSC_F_SAMPLE_SPRAY";
    constexpr char SYN_OSC_F_SAMPLE_XFADE[] = "SYN_OSC_F_SAMPLE_XFADE";
    constexpr char SYN_OSC_F_SAMPLE_START[] = "SYN_OSC_F_SAMPLE_START";
    constexpr char SYN_OSC_F_SAMPLE_END[] = "SYN_OSC_F_SAMPLE_END";
    constexpr char SYN_OSC_F_SAMPLE_LOOP_START[] = "SYN_OSC_F_SAMPLE_LOOP_START";
    constexpr char SYN_OSC_F_SAMPLE_LOOP_END[] = "SYN_OSC_F_SAMPLE_LOOP_END";
    constexpr char SYN_OSC_F_SAMPLE_LOOP_MODE[] = "SYN_OSC_F_SAMPLE_LOOP_MODE";
    constexpr char SYN_OSC_F_SAMPLE_SNAP[] = "SYN_OSC_F_SAMPLE_SNAP";
    constexpr char SYN_OSC_F_SAMPLE_STRETCH_MODE[] = "SYN_OSC_F_SAMPLE_STRETCH_MODE";
    constexpr char SYN_OSC_F_SAMPLE_FORMANT_MODE[] = "SYN_OSC_F_SAMPLE_FORMANT_MODE";
    constexpr char SYN_OSC_F_SAMPLE_FADE_IN[] = "SYN_OSC_F_SAMPLE_FADE_IN";
    constexpr char SYN_OSC_F_SAMPLE_FADE_OUT[] = "SYN_OSC_F_SAMPLE_FADE_OUT";
    constexpr char SYN_OSC_F_SAMPLE_AIR[] = "SYN_OSC_F_SAMPLE_AIR";
    constexpr char SYN_OSC_F_SAMPLE_WARP[] = "SYN_OSC_F_SAMPLE_WARP";
    constexpr char SYN_OSC_F_SAMPLE_WARPMODE[] = "SYN_OSC_F_SAMPLE_WARPMODE";
    constexpr char SYN_OSC_F_GRAIN_SCAN[] = "SYN_OSC_F_GRAIN_SCAN";
    constexpr char SYN_OSC_F_GRAIN_DENSITY[] = "SYN_OSC_F_GRAIN_DENSITY";
    constexpr char SYN_OSC_F_GRAIN_SIZE[] = "SYN_OSC_F_GRAIN_SIZE";
    constexpr char SYN_OSC_F_GRAIN_SPRAY[] = "SYN_OSC_F_GRAIN_SPRAY";
    constexpr char SYN_OSC_F_GRAIN_SHAPE[] = "SYN_OSC_F_GRAIN_SHAPE";
    constexpr char SYN_OSC_F_GRAIN_KEY[] = "SYN_OSC_F_GRAIN_KEY";
    constexpr char SYN_OSC_F_BLEND_MORPH[] = "SYN_OSC_F_BLEND_MORPH";
    constexpr char SYN_OSC_F_BLEND_ATTACK[] = "SYN_OSC_F_BLEND_ATTACK";
    constexpr char SYN_OSC_F_BLEND_BODY[] = "SYN_OSC_F_BLEND_BODY";
    constexpr char SYN_OSC_F_BLEND_BREATH[] = "SYN_OSC_F_BLEND_BREATH";
    constexpr char SYN_OSC_F_BLEND_SCULPT[] = "SYN_OSC_F_BLEND_SCULPT";
    constexpr char SYN_OSC_F_BLEND_DICE[] = "SYN_OSC_F_BLEND_DICE";
    constexpr char SYN_OSC_F_SAMPLE_FADEIN_CURVE[] = "SYN_OSC_F_SAMPLE_FADEIN_CURVE";
    constexpr char SYN_OSC_F_SAMPLE_FADEOUT_CURVE[] = "SYN_OSC_F_SAMPLE_FADEOUT_CURVE";
    constexpr char SYN_OSC_F_GRAIN_POSITION[] = "SYN_OSC_F_GRAIN_POSITION";
    constexpr char SYN_OSC_F_GRAIN_PITCH[] = "SYN_OSC_F_GRAIN_PITCH";
    constexpr char SYN_OSC_F_GRAIN_PSPRAY[] = "SYN_OSC_F_GRAIN_PSPRAY";
    constexpr char SYN_OSC_F_GRAIN_WIDTH[] = "SYN_OSC_F_GRAIN_WIDTH";
    constexpr char SYN_OSC_F_GRAIN_DIR[] = "SYN_OSC_F_GRAIN_DIR";
    constexpr char SYN_OSC_F_GRAIN_SKEW[] = "SYN_OSC_F_GRAIN_SKEW";
    constexpr char SYN_OSC_F_FM_ALGO[] = "SYN_OSC_F_FM_ALGO";
    constexpr char SYN_OSC_F_FM_RATIO1[] = "SYN_OSC_F_FM_RATIO1";
    constexpr char SYN_OSC_F_FM_DEPTH1[] = "SYN_OSC_F_FM_DEPTH1";
    constexpr char SYN_OSC_F_FM_RATIO2[] = "SYN_OSC_F_FM_RATIO2";
    constexpr char SYN_OSC_F_FM_DEPTH2[] = "SYN_OSC_F_FM_DEPTH2";
    constexpr char SYN_OSC_F_FM_FB[] = "SYN_OSC_F_FM_FB";
    constexpr char SYN_OSC_F_FM_STRIKE[] = "SYN_OSC_F_FM_STRIKE";
    constexpr char SYN_OSC_F_FM_AGE[] = "SYN_OSC_F_FM_AGE";
    constexpr char SYN_OSC_F_FM_RUST[] = "SYN_OSC_F_FM_RUST";
    constexpr char SYN_OSC_F_FM_GALE[] = "SYN_OSC_F_FM_GALE";
    constexpr char SYN_OSC_F_FM_BEND[] = "SYN_OSC_F_FM_BEND";
    constexpr char SYN_OSC_F_FM_STORM[] = "SYN_OSC_F_FM_STORM";
    constexpr char SYN_OSC_F_GEODE_POSITION[] = "SYN_OSC_F_GEODE_POSITION";
    constexpr char SYN_OSC_F_GEODE_FOSSIL[] = "SYN_OSC_F_GEODE_FOSSIL";
    constexpr char SYN_OSC_F_GEODE_CREEP[] = "SYN_OSC_F_GEODE_CREEP";
    constexpr char SYN_OSC_F_GEODE_SILT[] = "SYN_OSC_F_GEODE_SILT";
    constexpr char SYN_OSC_F_GEODE_FORMANT[] = "SYN_OSC_F_GEODE_FORMANT";
    constexpr char SYN_OSC_F_GEODE_CUT[] = "SYN_OSC_F_GEODE_CUT";
    constexpr char SYN_OSC_F_GEODE_SIEVE[] = "SYN_OSC_F_GEODE_SIEVE";
    constexpr char SYN_OSC_F_GEODE_DISTILL[] = "SYN_OSC_F_GEODE_DISTILL";
    constexpr char SYN_OSC_F_GEODE_HAZE[] = "SYN_OSC_F_GEODE_HAZE";
    constexpr char SYN_OSC_F_GEODE_FRACTURE[] = "SYN_OSC_F_GEODE_FRACTURE";
    constexpr char SYN_OSC_F_GEODE_TILT[] = "SYN_OSC_F_GEODE_TILT";
    constexpr char SYN_OSC_F_GEODE_QUALITY[] = "SYN_OSC_F_GEODE_QUALITY";
    constexpr char SYN_OSC_F_GEODE_FKEEP[] = "SYN_OSC_F_GEODE_FKEEP";
    constexpr char SYN_OSC_F_GEODE_LOOP[] = "SYN_OSC_F_GEODE_LOOP";
    constexpr char SYN_OSC_F_GEODE_BEDROCK[] = "SYN_OSC_F_GEODE_BEDROCK";
    constexpr char SYN_OSC_F_GEODE_SHAPE_TARGET[] = "SYN_OSC_F_GEODE_SHAPE_TARGET";
    constexpr char SYN_OSC_F_GEODE_CUT_MODE[] = "SYN_OSC_F_GEODE_CUT_MODE";
    constexpr char SYN_OSC_F_GEODE_DRIVE_MODE[] = "SYN_OSC_F_GEODE_DRIVE_MODE";
    constexpr char SYN_OSC_F_GEODE_SIEVE_MODE[] = "SYN_OSC_F_GEODE_SIEVE_MODE";
    constexpr char SYN_OSC_F_HARM_MODE[] = "SYN_OSC_F_HARM_MODE";
    constexpr char SYN_OSC_F_HARM_SCULPT[] = "SYN_OSC_F_HARM_SCULPT";
    constexpr char SYN_OSC_F_HARM_HUE[] = "SYN_OSC_F_HARM_HUE";
    constexpr char SYN_OSC_F_HARM_COUNT[] = "SYN_OSC_F_HARM_COUNT";
    constexpr char SYN_OSC_F_HARM_LEAN[] = "SYN_OSC_F_HARM_LEAN";
    constexpr char SYN_OSC_F_HARM_FAN[] = "SYN_OSC_F_HARM_FAN";
    constexpr char SYN_OSC_F_HARM_GRIT[] = "SYN_OSC_F_HARM_GRIT";
    constexpr char SYN_OSC_F_HARM_BRAID[] = "SYN_OSC_F_HARM_BRAID";
    constexpr char SYN_OSC_F_HARM_CARVE[] = "SYN_OSC_F_HARM_CARVE";
    constexpr char SYN_OSC_F_HARM_CHURN[] = "SYN_OSC_F_HARM_CHURN";
    constexpr char SYN_OSC_F_HARM_ROOT[] = "SYN_OSC_F_HARM_ROOT";
    constexpr char SYN_OSC_F_HARM_SHINE[] = "SYN_OSC_F_HARM_SHINE";
    constexpr char SYN_OSC_F_HARM_WILT[] = "SYN_OSC_F_HARM_WILT";
    constexpr char SYN_OSC_F_HARM_FIZZ[] = "SYN_OSC_F_HARM_FIZZ";
    constexpr char SYN_OSC_F_HARM_TABLE[] = "SYN_OSC_F_HARM_TABLE";
    constexpr char SYN_OSC_F_COARSE[] = "SYN_OSC_F_COARSE";
    constexpr char SYN_OSC_F_SUB_RANGE[] = "SYN_OSC_F_SUB_RANGE";
    constexpr char SYN_OSC_F_SUB_FORM[] = "SYN_OSC_F_SUB_FORM";
    constexpr char SYN_OSC_F_SUB_WEIGHT[] = "SYN_OSC_F_SUB_WEIGHT";
    constexpr char SYN_OSC_F_SUB_HEAT[] = "SYN_OSC_F_SUB_HEAT";
    constexpr char SYN_OSC_F_MODAL_FAMILY[] = "SYN_OSC_F_MODAL_FAMILY";
    constexpr char SYN_OSC_F_MODAL_FORM[] = "SYN_OSC_F_MODAL_FORM";
    constexpr char SYN_OSC_F_MODAL_SOURCE[] = "SYN_OSC_F_MODAL_SOURCE";
    constexpr char SYN_OSC_F_MODAL_HARD[] = "SYN_OSC_F_MODAL_HARD";
    constexpr char SYN_OSC_F_MODAL_POS[] = "SYN_OSC_F_MODAL_POS";
    constexpr char SYN_OSC_F_MODAL_DECAY[] = "SYN_OSC_F_MODAL_DECAY";
    constexpr char SYN_OSC_F_MODAL_MATERIAL[] = "SYN_OSC_F_MODAL_MATERIAL";
    constexpr char SYN_OSC_F_MODAL_BREATH[] = "SYN_OSC_F_MODAL_BREATH";
    constexpr char SYN_OSC_F_MODAL_STRETCH[] = "SYN_OSC_F_MODAL_STRETCH";
    constexpr char SYN_OSC_F_MODAL_BLOOM[] = "SYN_OSC_F_MODAL_BLOOM";
    constexpr char SYN_OSC_F_MODAL_HALO[] = "SYN_OSC_F_MODAL_HALO";
    constexpr char SYN_OSC_F_MODAL_AGE[] = "SYN_OSC_F_MODAL_AGE";
    constexpr char SYN_OSC_F_MODAL_BODY[] = "SYN_OSC_F_MODAL_BODY";
    constexpr char SYN_OSC_F_ORG_INST[] = "SYN_OSC_F_ORG_INST";
    constexpr char SYN_OSC_F_ORG_ARTIC[] = "SYN_OSC_F_ORG_ARTIC";
    constexpr char SYN_OSC_F_ORG_DYNAMICS[] = "SYN_OSC_F_ORG_DYNAMICS";
    constexpr char SYN_OSC_F_ORG_TONE[] = "SYN_OSC_F_ORG_TONE";
    constexpr char SYN_OSC_F_ORG_BODY[] = "SYN_OSC_F_ORG_BODY";
    constexpr char SYN_OSC_F_ORG_ATTACK[] = "SYN_OSC_F_ORG_ATTACK";
    constexpr char SYN_OSC_F_ORG_HUMAN[] = "SYN_OSC_F_ORG_HUMAN";
    constexpr char SYN_OSC_F_ORG_RELEASE[] = "SYN_OSC_F_ORG_RELEASE";
    constexpr char SYN_OSC_F_ORG_NOISE[] = "SYN_OSC_F_ORG_NOISE";
    ...
    constexpr char SYN_OSC_F_WSLOT2_MODE[] = "SYN_OSC_F_WSLOT2_MODE";
    constexpr char SYN_OSC_F_WSLOT2_SRC[] = "SYN_OSC_F_WSLOT2_SRC";
    constexpr char SYN_OSC_F_WSLOT2_DEPTH[] = "SYN_OSC_F_WSLOT2_DEPTH";
    constexpr char SYN_OSC_F_WSLOT3_MODE[] = "SYN_OSC_F_WSLOT3_MODE";
    constexpr char SYN_OSC_F_WSLOT3_SRC[] = "SYN_OSC_F_WSLOT3_SRC";
    constexpr char SYN_OSC_F_WSLOT3_DEPTH[] = "SYN_OSC_F_WSLOT3_DEPTH";
    constexpr char SYN_OSC_F_WSLOT4_MODE[] = "SYN_OSC_F_WSLOT4_MODE";
    constexpr char SYN_OSC_F_WSLOT4_SRC[] = "SYN_OSC_F_WSLOT4_SRC";
    constexpr char SYN_OSC_F_WSLOT4_DEPTH[] = "SYN_OSC_F_WSLOT4_DEPTH";
    // ── OSC G ──
    constexpr char SYN_OSC_G_ENGINE[] = "SYN_OSC_G_ENGINE";
    constexpr char SYN_OSC_G_OCT[] = "SYN_OSC_G_OCT";
    constexpr char SYN_OSC_G_SEMI[] = "SYN_OSC_G_SEMI";
    constexpr char SYN_OSC_G_CENT[] = "SYN_OSC_G_CENT";
    constexpr char SYN_OSC_G_LEVEL[] = "SYN_OSC_G_LEVEL";
    constexpr char SYN_OSC_G_PAN[] = "SYN_OSC_G_PAN";
    constexpr char SYN_OSC_G_ENABLE[] = "SYN_OSC_G_ENABLE";
    constexpr char SYN_OSC_G_MUTE[] = "SYN_OSC_G_MUTE";
    constexpr char SYN_OSC_G_SOLO[] = "SYN_OSC_G_SOLO";
    constexpr char SYN_OSC_G_F1MIX[] = "SYN_OSC_G_F1MIX";
    constexpr char SYN_OSC_G_F2MIX[] = "SYN_OSC_G_F2MIX";
    constexpr char SYN_OSC_G_WT_PRESET[] = "SYN_OSC_G_WT_PRESET";
    constexpr char SYN_OSC_G_WT_FRAME[] = "SYN_OSC_G_WT_FRAME";
    constexpr char SYN_OSC_G_WARP_MODE[] = "SYN_OSC_G_WARP_MODE";
    constexpr char SYN_OSC_G_WARP_AMOUNT[] = "SYN_OSC_G_WARP_AMOUNT";
    constexpr char SYN_OSC_G_WARP2_MODE[] = "SYN_OSC_G_WARP2_MODE";
    constexpr char SYN_OSC_G_WARP2_AMT[] = "SYN_OSC_G_WARP2_AMT";
    constexpr char SYN_OSC_G_SPECTRAL_TYPE[] = "SYN_OSC_G_SPECTRAL_TYPE";
    constexpr char SYN_OSC_G_SPECTRAL_AMT[] = "SYN_OSC_G_SPECTRAL_AMT";
    constexpr char SYN_OSC_G_SPECTRAL_LO[] = "SYN_OSC_G_SPECTRAL_LO";
    constexpr char SYN_OSC_G_SPECTRAL_HI[] = "SYN_OSC_G_SPECTRAL_HI";
    constexpr char SYN_OSC_G_FOLD_SHAPE[] = "SYN_OSC_G_FOLD_SHAPE";
    constexpr char SYN_OSC_G_FOLD_AMT[] = "SYN_OSC_G_FOLD_AMT";
    constexpr char SYN_OSC_G_FRAME_SPREAD[] = "SYN_OSC_G_FRAME_SPREAD";
    constexpr char SYN_OSC_G_INTERP_MODE[] = "SYN_OSC_G_INTERP_MODE";
    constexpr char SYN_OSC_G_PHASE_MODE[] = "SYN_OSC_G_PHASE_MODE";
    constexpr char SYN_OSC_G_WAVER[] = "SYN_OSC_G_WAVER";
    constexpr char SYN_OSC_G_KEYTRACK[] = "SYN_OSC_G_KEYTRACK";
    constexpr char SYN_OSC_G_KEYTRACK_DEST[] = "SYN_OSC_G_KEYTRACK_DEST";
    constexpr char SYN_OSC_G_ROUTE_SRC[] = "SYN_OSC_G_ROUTE_SRC";
    constexpr char SYN_OSC_G_ROUTE_DEST[] = "SYN_OSC_G_ROUTE_DEST";
    constexpr char SYN_OSC_G_ROUTE_AMT[] = "SYN_OSC_G_ROUTE_AMT";
    constexpr char SYN_OSC_G_UNISON[] = "SYN_OSC_G_UNISON";
    constexpr char SYN_OSC_G_UDETUNE[] = "SYN_OSC_G_UDETUNE";
    constexpr char SYN_OSC_G_UBLEND[] = "SYN_OSC_G_UBLEND";
    constexpr char SYN_OSC_G_UWIDTH[] = "SYN_OSC_G_UWIDTH";
    constexpr char SYN_OSC_G_URANGE[] = "SYN_OSC_G_URANGE";
    constexpr char SYN_OSC_G_UWARP[] = "SYN_OSC_G_UWARP";
    constexpr char SYN_OSC_G_USTACK[] = "SYN_OSC_G_USTACK";
    constexpr char SYN_OSC_G_WVAR[] = "SYN_OSC_G_WVAR";
    constexpr char SYN_OSC_G_W2VAR[] = "SYN_OSC_G_W2VAR";
    constexpr char SYN_OSC_G_PHASE[] = "SYN_OSC_G_PHASE";
    constexpr char SYN_OSC_G_PHASE_AMT[] = "SYN_OSC_G_PHASE_AMT";
    constexpr char SYN_OSC_G_SAMPLE_SCAN[] = "SYN_OSC_G_SAMPLE_SCAN";
    constexpr char SYN_OSC_G_SAMPLE_STRETCH[] = "SYN_OSC_G_SAMPLE_STRETCH";
    constexpr char SYN_OSC_G_SAMPLE_FORMANT[] = "SYN_OSC_G_SAMPLE_FORMANT";
    constexpr char SYN_OSC_G_SAMPLE_SPRAY[] = "SYN_OSC_G_SAMPLE_SPRAY";
    constexpr char SYN_OSC_G_SAMPLE_XFADE[] = "SYN_OSC_G_SAMPLE_XFADE";
    constexpr char SYN_OSC_G_SAMPLE_START[] = "SYN_OSC_G_SAMPLE_START";
    constexpr char SYN_OSC_G_SAMPLE_END[] = "SYN_OSC_G_SAMPLE_END";
    constexpr char SYN_OSC_G_SAMPLE_LOOP_START[] = "SYN_OSC_G_SAMPLE_LOOP_START";
    constexpr char SYN_OSC_G_SAMPLE_LOOP_END[] = "SYN_OSC_G_SAMPLE_LOOP_END";
    constexpr char SYN_OSC_G_SAMPLE_LOOP_MODE[] = "SYN_OSC_G_SAMPLE_LOOP_MODE";
    constexpr char SYN_OSC_G_SAMPLE_SNAP[] = "SYN_OSC_G_SAMPLE_SNAP";
    constexpr char SYN_OSC_G_SAMPLE_STRETCH_MODE[] = "SYN_OSC_G_SAMPLE_STRETCH_MODE";
    constexpr char SYN_OSC_G_SAMPLE_FORMANT_MODE[] = "SYN_OSC_G_SAMPLE_FORMANT_MODE";
    constexpr char SYN_OSC_G_SAMPLE_FADE_IN[] = "SYN_OSC_G_SAMPLE_FADE_IN";
    constexpr char SYN_OSC_G_SAMPLE_FADE_OUT[] = "SYN_OSC_G_SAMPLE_FADE_OUT";
    constexpr char SYN_OSC_G_SAMPLE_AIR[] = "SYN_OSC_G_SAMPLE_AIR";
    constexpr char SYN_OSC_G_SAMPLE_WARP[] = "SYN_OSC_G_SAMPLE_WARP";
    constexpr char SYN_OSC_G_SAMPLE_WARPMODE[] = "SYN_OSC_G_SAMPLE_WARPMODE";
    constexpr char SYN_OSC_G_GRAIN_SCAN[] = "SYN_OSC_G_GRAIN_SCAN";
    constexpr char SYN_OSC_G_GRAIN_DENSITY[] = "SYN_OSC_G_GRAIN_DENSITY";
    constexpr char SYN_OSC_G_GRAIN_SIZE[] = "SYN_OSC_G_GRAIN_SIZE";
    constexpr char SYN_OSC_G_GRAIN_SPRAY[] = "SYN_OSC_G_GRAIN_SPRAY";
    constexpr char SYN_OSC_G_GRAIN_SHAPE[] = "SYN_OSC_G_GRAIN_SHAPE";
    constexpr char SYN_OSC_G_GRAIN_KEY[] = "SYN_OSC_G_GRAIN_KEY";
    constexpr char SYN_OSC_G_BLEND_MORPH[] = "SYN_OSC_G_BLEND_MORPH";
    constexpr char SYN_OSC_G_BLEND_ATTACK[] = "SYN_OSC_G_BLEND_ATTACK";
    constexpr char SYN_OSC_G_BLEND_BODY[] = "SYN_OSC_G_BLEND_BODY";
    constexpr char SYN_OSC_G_BLEND_BREATH[] = "SYN_OSC_G_BLEND_BREATH";
    constexpr char SYN_OSC_G_BLEND_SCULPT[] = "SYN_OSC_G_BLEND_SCULPT";
    constexpr char SYN_OSC_G_BLEND_DICE[] = "SYN_OSC_G_BLEND_DICE";
    constexpr char SYN_OSC_G_SAMPLE_FADEIN_CURVE[] = "SYN_OSC_G_SAMPLE_FADEIN_CURVE";
    constexpr char SYN_OSC_G_SAMPLE_FADEOUT_CURVE[] = "SYN_OSC_G_SAMPLE_FADEOUT_CURVE";
    constexpr char SYN_OSC_G_GRAIN_POSITION[] = "SYN_OSC_G_GRAIN_POSITION";
    constexpr char SYN_OSC_G_GRAIN_PITCH[] = "SYN_OSC_G_GRAIN_PITCH";
    constexpr char SYN_OSC_G_GRAIN_PSPRAY[] = "SYN_OSC_G_GRAIN_PSPRAY";
    constexpr char SYN_OSC_G_GRAIN_WIDTH[] = "SYN_OSC_G_GRAIN_WIDTH";
    constexpr char SYN_OSC_G_GRAIN_DIR[] = "SYN_OSC_G_GRAIN_DIR";
    constexpr char SYN_OSC_G_GRAIN_SKEW[] = "SYN_OSC_G_GRAIN_SKEW";
    constexpr char SYN_OSC_G_FM_ALGO[] = "SYN_OSC_G_FM_ALGO";
    constexpr char SYN_OSC_G_FM_RATIO1[] = "SYN_OSC_G_FM_RATIO1";
    constexpr char SYN_OSC_G_FM_DEPTH1[] = "SYN_OSC_G_FM_DEPTH1";
    constexpr char SYN_OSC_G_FM_RATIO2[] = "SYN_OSC_G_FM_RATIO2";
    constexpr char SYN_OSC_G_FM_DEPTH2[] = "SYN_OSC_G_FM_DEPTH2";
    constexpr char SYN_OSC_G_FM_FB[] = "SYN_OSC_G_FM_FB";
    constexpr char SYN_OSC_G_FM_STRIKE[] = "SYN_OSC_G_FM_STRIKE";
    constexpr char SYN_OSC_G_FM_AGE[] = "SYN_OSC_G_FM_AGE";
    constexpr char SYN_OSC_G_FM_RUST[] = "SYN_OSC_G_FM_RUST";
    constexpr char SYN_OSC_G_FM_GALE[] = "SYN_OSC_G_FM_GALE";
    constexpr char SYN_OSC_G_FM_BEND[] = "SYN_OSC_G_FM_BEND";
    constexpr char SYN_OSC_G_FM_STORM[] = "SYN_OSC_G_FM_STORM";
    constexpr char SYN_OSC_G_GEODE_POSITION[] = "SYN_OSC_G_GEODE_POSITION";
    constexpr char SYN_OSC_G_GEODE_FOSSIL[] = "SYN_OSC_G_GEODE_FOSSIL";
    constexpr char SYN_OSC_G_GEODE_CREEP[] = "SYN_OSC_G_GEODE_CREEP";
    constexpr char SYN_OSC_G_GEODE_SILT[] = "SYN_OSC_G_GEODE_SILT";
    constexpr char SYN_OSC_G_GEODE_FORMANT[] = "SYN_OSC_G_GEODE_FORMANT";
    constexpr char SYN_OSC_G_GEODE_CUT[] = "SYN_OSC_G_GEODE_CUT";
    constexpr char SYN_OSC_G_GEODE_SIEVE[] = "SYN_OSC_G_GEODE_SIEVE";
    constexpr char SYN_OSC_G_GEODE_DISTILL[] = "SYN_OSC_G_GEODE_DISTILL";
    constexpr char SYN_OSC_G_GEODE_HAZE[] = "SYN_OSC_G_GEODE_HAZE";
    constexpr char SYN_OSC_G_GEODE_FRACTURE[] = "SYN_OSC_G_GEODE_FRACTURE";
    constexpr char SYN_OSC_G_GEODE_TILT[] = "SYN_OSC_G_GEODE_TILT";
    constexpr char SYN_OSC_G_GEODE_QUALITY[] = "SYN_OSC_G_GEODE_QUALITY";
    constexpr char SYN_OSC_G_GEODE_FKEEP[] = "SYN_OSC_G_GEODE_FKEEP";
    constexpr char SYN_OSC_G_GEODE_LOOP[] = "SYN_OSC_G_GEODE_LOOP";
    constexpr char SYN_OSC_G_GEODE_BEDROCK[] = "SYN_OSC_G_GEODE_BEDROCK";
    constexpr char SYN_OSC_G_GEODE_SHAPE_TARGET[] = "SYN_OSC_G_GEODE_SHAPE_TARGET";
    constexpr char SYN_OSC_G_GEODE_CUT_MODE[] = "SYN_OSC_G_GEODE_CUT_MODE";
    constexpr char SYN_OSC_G_GEODE_DRIVE_MODE[] = "SYN_OSC_G_GEODE_DRIVE_MODE";
    constexpr char SYN_OSC_G_GEODE_SIEVE_MODE[] = "SYN_OSC_G_GEODE_SIEVE_MODE";
    constexpr char SYN_OSC_G_HARM_MODE[] = "SYN_OSC_G_HARM_MODE";
    constexpr char SYN_OSC_G_HARM_SCULPT[] = "SYN_OSC_G_HARM_SCULPT";
    constexpr char SYN_OSC_G_HARM_HUE[] = "SYN_OSC_G_HARM_HUE";
    constexpr char SYN_OSC_G_HARM_COUNT[] = "SYN_OSC_G_HARM_COUNT";
    constexpr char SYN_OSC_G_HARM_LEAN[] = "SYN_OSC_G_HARM_LEAN";
    constexpr char SYN_OSC_G_HARM_FAN[] = "SYN_OSC_G_HARM_FAN";
    constexpr char SYN_OSC_G_HARM_GRIT[] = "SYN_OSC_G_HARM_GRIT";
    constexpr char SYN_OSC_G_HARM_BRAID[] = "SYN_OSC_G_HARM_BRAID";
    constexpr char SYN_OSC_G_HARM_CARVE[] = "SYN_OSC_G_HARM_CARVE";
    constexpr char SYN_OSC_G_HARM_CHURN[] = "SYN_OSC_G_HARM_CHURN";
    constexpr char SYN_OSC_G_HARM_ROOT[] = "SYN_OSC_G_HARM_ROOT";
    constexpr char SYN_OSC_G_HARM_SHINE[] = "SYN_OSC_G_HARM_SHINE";
    constexpr char SYN_OSC_G_HARM_WILT[] = "SYN_OSC_G_HARM_WILT";
    constexpr char SYN_OSC_G_HARM_FIZZ[] = "SYN_OSC_G_HARM_FIZZ";
    constexpr char SYN_OSC_G_HARM_TABLE[] = "SYN_OSC_G_HARM_TABLE";
    constexpr char SYN_OSC_G_COARSE[] = "SYN_OSC_G_COARSE";
    constexpr char SYN_OSC_G_SUB_RANGE[] = "SYN_OSC_G_SUB_RANGE";
    constexpr char SYN_OSC_G_SUB_FORM[] = "SYN_OSC_G_SUB_FORM";
    constexpr char SYN_OSC_G_SUB_WEIGHT[] = "SYN_OSC_G_SUB_WEIGHT";
    constexpr char SYN_OSC_G_SUB_HEAT[] = "SYN_OSC_G_SUB_HEAT";
    constexpr char SYN_OSC_G_MODAL_FAMILY[] = "SYN_OSC_G_MODAL_FAMILY";
    constexpr char SYN_OSC_G_MODAL_FORM[] = "SYN_OSC_G_MODAL_FORM";
    constexpr char SYN_OSC_G_MODAL_SOURCE[] = "SYN_OSC_G_MODAL_SOURCE";
    constexpr char SYN_OSC_G_MODAL_HARD[] = "SYN_OSC_G_MODAL_HARD";
    constexpr char SYN_OSC_G_MODAL_POS[] = "SYN_OSC_G_MODAL_POS";
    constexpr char SYN_OSC_G_MODAL_DECAY[] = "SYN_OSC_G_MODAL_DECAY";
    constexpr char SYN_OSC_G_MODAL_MATERIAL[] = "SYN_OSC_G_MODAL_MATERIAL";
    constexpr char SYN_OSC_G_MODAL_BREATH[] = "SYN_OSC_G_MODAL_BREATH";
    constexpr char SYN_OSC_G_MODAL_STRETCH[] = "SYN_OSC_G_MODAL_STRETCH";
    constexpr char SYN_OSC_G_MODAL_BLOOM[] = "SYN_OSC_G_MODAL_BLOOM";
    constexpr char SYN_OSC_G_MODAL_HALO[] = "SYN_OSC_G_MODAL_HALO";
    constexpr char SYN_OSC_G_MODAL_AGE[] = "SYN_OSC_G_MODAL_AGE";
    constexpr char SYN_OSC_G_MODAL_BODY[] = "SYN_OSC_G_MODAL_BODY";
    constexpr char SYN_OSC_G_ORG_INST[] = "SYN_OSC_G_ORG_INST";
    constexpr char SYN_OSC_G_ORG_ARTIC[] = "SYN_OSC_G_ORG_ARTIC";
    constexpr char SYN_OSC_G_ORG_DYNAMICS[] = "SYN_OSC_G_ORG_DYNAMICS";
    constexpr char SYN_OSC_G_ORG_TONE[] = "SYN_OSC_G_ORG_TONE";
    constexpr char SYN_OSC_G_ORG_BODY[] = "SYN_OSC_G_ORG_BODY";
    constexpr char SYN_OSC_G_ORG_ATTACK[] = "SYN_OSC_G_ORG_ATTACK";
    constexpr char SYN_OSC_G_ORG_HUMAN[] = "SYN_OSC_G_ORG_HUMAN";
    constexpr char SYN_OSC_G_ORG_RELEASE[] = "SYN_OSC_G_ORG_RELEASE";
    constexpr char SYN_OSC_G_ORG_NOISE[] = "SYN_OSC_G_ORG_NOISE";
    ...
    constexpr char SYN_OSC_G_WSLOT2_MODE[] = "SYN_OSC_G_WSLOT2_MODE";
    constexpr char SYN_OSC_G_WSLOT2_SRC[] = "SYN_OSC_G_WSLOT2_SRC";
    constexpr char SYN_OSC_G_WSLOT2_DEPTH[] = "SYN_OSC_G_WSLOT2_DEPTH";
    constexpr char SYN_OSC_G_WSLOT3_MODE[] = "SYN_OSC_G_WSLOT3_MODE";
    constexpr char SYN_OSC_G_WSLOT3_SRC[] = "SYN_OSC_G_WSLOT3_SRC";
    constexpr char SYN_OSC_G_WSLOT3_DEPTH[] = "SYN_OSC_G_WSLOT3_DEPTH";
    constexpr char SYN_OSC_G_WSLOT4_MODE[] = "SYN_OSC_G_WSLOT4_MODE";
    constexpr char SYN_OSC_G_WSLOT4_SRC[] = "SYN_OSC_G_WSLOT4_SRC";
    constexpr char SYN_OSC_G_WSLOT4_DEPTH[] = "SYN_OSC_G_WSLOT4_DEPTH";
    // ── OSC H ──
    constexpr char SYN_OSC_H_ENGINE[] = "SYN_OSC_H_ENGINE";
    constexpr char SYN_OSC_H_OCT[] = "SYN_OSC_H_OCT";
    constexpr char SYN_OSC_H_SEMI[] = "SYN_OSC_H_SEMI";
    constexpr char SYN_OSC_H_CENT[] = "SYN_OSC_H_CENT";
    constexpr char SYN_OSC_H_LEVEL[] = "SYN_OSC_H_LEVEL";
    constexpr char SYN_OSC_H_PAN[] = "SYN_OSC_H_PAN";
    constexpr char SYN_OSC_H_ENABLE[] = "SYN_OSC_H_ENABLE";
    constexpr char SYN_OSC_H_MUTE[] = "SYN_OSC_H_MUTE";
    constexpr char SYN_OSC_H_SOLO[] = "SYN_OSC_H_SOLO";
    constexpr char SYN_OSC_H_F1MIX[] = "SYN_OSC_H_F1MIX";
    constexpr char SYN_OSC_H_F2MIX[] = "SYN_OSC_H_F2MIX";
    constexpr char SYN_OSC_H_WT_PRESET[] = "SYN_OSC_H_WT_PRESET";
    constexpr char SYN_OSC_H_WT_FRAME[] = "SYN_OSC_H_WT_FRAME";
    constexpr char SYN_OSC_H_WARP_MODE[] = "SYN_OSC_H_WARP_MODE";
    constexpr char SYN_OSC_H_WARP_AMOUNT[] = "SYN_OSC_H_WARP_AMOUNT";
    constexpr char SYN_OSC_H_WARP2_MODE[] = "SYN_OSC_H_WARP2_MODE";
    constexpr char SYN_OSC_H_WARP2_AMT[] = "SYN_OSC_H_WARP2_AMT";
    constexpr char SYN_OSC_H_SPECTRAL_TYPE[] = "SYN_OSC_H_SPECTRAL_TYPE";
    constexpr char SYN_OSC_H_SPECTRAL_AMT[] = "SYN_OSC_H_SPECTRAL_AMT";
    constexpr char SYN_OSC_H_SPECTRAL_LO[] = "SYN_OSC_H_SPECTRAL_LO";
    constexpr char SYN_OSC_H_SPECTRAL_HI[] = "SYN_OSC_H_SPECTRAL_HI";
    constexpr char SYN_OSC_H_FOLD_SHAPE[] = "SYN_OSC_H_FOLD_SHAPE";
    constexpr char SYN_OSC_H_FOLD_AMT[] = "SYN_OSC_H_FOLD_AMT";
    constexpr char SYN_OSC_H_FRAME_SPREAD[] = "SYN_OSC_H_FRAME_SPREAD";
    constexpr char SYN_OSC_H_INTERP_MODE[] = "SYN_OSC_H_INTERP_MODE";
    constexpr char SYN_OSC_H_PHASE_MODE[] = "SYN_OSC_H_PHASE_MODE";
    constexpr char SYN_OSC_H_WAVER[] = "SYN_OSC_H_WAVER";
    constexpr char SYN_OSC_H_KEYTRACK[] = "SYN_OSC_H_KEYTRACK";
    constexpr char SYN_OSC_H_KEYTRACK_DEST[] = "SYN_OSC_H_KEYTRACK_DEST";
    constexpr char SYN_OSC_H_ROUTE_SRC[] = "SYN_OSC_H_ROUTE_SRC";
    constexpr char SYN_OSC_H_ROUTE_DEST[] = "SYN_OSC_H_ROUTE_DEST";
    constexpr char SYN_OSC_H_ROUTE_AMT[] = "SYN_OSC_H_ROUTE_AMT";
    constexpr char SYN_OSC_H_UNISON[] = "SYN_OSC_H_UNISON";
    constexpr char SYN_OSC_H_UDETUNE[] = "SYN_OSC_H_UDETUNE";
    constexpr char SYN_OSC_H_UBLEND[] = "SYN_OSC_H_UBLEND";
    constexpr char SYN_OSC_H_UWIDTH[] = "SYN_OSC_H_UWIDTH";
    constexpr char SYN_OSC_H_URANGE[] = "SYN_OSC_H_URANGE";
    constexpr char SYN_OSC_H_UWARP[] = "SYN_OSC_H_UWARP";
    constexpr char SYN_OSC_H_USTACK[] = "SYN_OSC_H_USTACK";
    constexpr char SYN_OSC_H_WVAR[] = "SYN_OSC_H_WVAR";
    constexpr char SYN_OSC_H_W2VAR[] = "SYN_OSC_H_W2VAR";
    constexpr char SYN_OSC_H_PHASE[] = "SYN_OSC_H_PHASE";
    constexpr char SYN_OSC_H_PHASE_AMT[] = "SYN_OSC_H_PHASE_AMT";
    constexpr char SYN_OSC_H_SAMPLE_SCAN[] = "SYN_OSC_H_SAMPLE_SCAN";
    constexpr char SYN_OSC_H_SAMPLE_STRETCH[] = "SYN_OSC_H_SAMPLE_STRETCH";
    constexpr char SYN_OSC_H_SAMPLE_FORMANT[] = "SYN_OSC_H_SAMPLE_FORMANT";
    constexpr char SYN_OSC_H_SAMPLE_SPRAY[] = "SYN_OSC_H_SAMPLE_SPRAY";
    constexpr char SYN_OSC_H_SAMPLE_XFADE[] = "SYN_OSC_H_SAMPLE_XFADE";
    constexpr char SYN_OSC_H_SAMPLE_START[] = "SYN_OSC_H_SAMPLE_START";
    constexpr char SYN_OSC_H_SAMPLE_END[] = "SYN_OSC_H_SAMPLE_END";
    constexpr char SYN_OSC_H_SAMPLE_LOOP_START[] = "SYN_OSC_H_SAMPLE_LOOP_START";
    constexpr char SYN_OSC_H_SAMPLE_LOOP_END[] = "SYN_OSC_H_SAMPLE_LOOP_END";
    constexpr char SYN_OSC_H_SAMPLE_LOOP_MODE[] = "SYN_OSC_H_SAMPLE_LOOP_MODE";
    constexpr char SYN_OSC_H_SAMPLE_SNAP[] = "SYN_OSC_H_SAMPLE_SNAP";
    constexpr char SYN_OSC_H_SAMPLE_STRETCH_MODE[] = "SYN_OSC_H_SAMPLE_STRETCH_MODE";
    constexpr char SYN_OSC_H_SAMPLE_FORMANT_MODE[] = "SYN_OSC_H_SAMPLE_FORMANT_MODE";
    constexpr char SYN_OSC_H_SAMPLE_FADE_IN[] = "SYN_OSC_H_SAMPLE_FADE_IN";
    constexpr char SYN_OSC_H_SAMPLE_FADE_OUT[] = "SYN_OSC_H_SAMPLE_FADE_OUT";
    constexpr char SYN_OSC_H_SAMPLE_AIR[] = "SYN_OSC_H_SAMPLE_AIR";
    constexpr char SYN_OSC_H_SAMPLE_WARP[] = "SYN_OSC_H_SAMPLE_WARP";
    constexpr char SYN_OSC_H_SAMPLE_WARPMODE[] = "SYN_OSC_H_SAMPLE_WARPMODE";
    constexpr char SYN_OSC_H_GRAIN_SCAN[] = "SYN_OSC_H_GRAIN_SCAN";
    constexpr char SYN_OSC_H_GRAIN_DENSITY[] = "SYN_OSC_H_GRAIN_DENSITY";
    constexpr char SYN_OSC_H_GRAIN_SIZE[] = "SYN_OSC_H_GRAIN_SIZE";
    constexpr char SYN_OSC_H_GRAIN_SPRAY[] = "SYN_OSC_H_GRAIN_SPRAY";
    constexpr char SYN_OSC_H_GRAIN_SHAPE[] = "SYN_OSC_H_GRAIN_SHAPE";
    constexpr char SYN_OSC_H_GRAIN_KEY[] = "SYN_OSC_H_GRAIN_KEY";
    constexpr char SYN_OSC_H_BLEND_MORPH[] = "SYN_OSC_H_BLEND_MORPH";
    constexpr char SYN_OSC_H_BLEND_ATTACK[] = "SYN_OSC_H_BLEND_ATTACK";
    constexpr char SYN_OSC_H_BLEND_BODY[] = "SYN_OSC_H_BLEND_BODY";
    constexpr char SYN_OSC_H_BLEND_BREATH[] = "SYN_OSC_H_BLEND_BREATH";
    constexpr char SYN_OSC_H_BLEND_SCULPT[] = "SYN_OSC_H_BLEND_SCULPT";
    constexpr char SYN_OSC_H_BLEND_DICE[] = "SYN_OSC_H_BLEND_DICE";
    constexpr char SYN_OSC_H_SAMPLE_FADEIN_CURVE[] = "SYN_OSC_H_SAMPLE_FADEIN_CURVE";
    constexpr char SYN_OSC_H_SAMPLE_FADEOUT_CURVE[] = "SYN_OSC_H_SAMPLE_FADEOUT_CURVE";
    constexpr char SYN_OSC_H_GRAIN_POSITION[] = "SYN_OSC_H_GRAIN_POSITION";
    constexpr char SYN_OSC_H_GRAIN_PITCH[] = "SYN_OSC_H_GRAIN_PITCH";
    constexpr char SYN_OSC_H_GRAIN_PSPRAY[] = "SYN_OSC_H_GRAIN_PSPRAY";
    constexpr char SYN_OSC_H_GRAIN_WIDTH[] = "SYN_OSC_H_GRAIN_WIDTH";
    constexpr char SYN_OSC_H_GRAIN_DIR[] = "SYN_OSC_H_GRAIN_DIR";
    constexpr char SYN_OSC_H_GRAIN_SKEW[] = "SYN_OSC_H_GRAIN_SKEW";
    constexpr char SYN_OSC_H_FM_ALGO[] = "SYN_OSC_H_FM_ALGO";
    constexpr char SYN_OSC_H_FM_RATIO1[] = "SYN_OSC_H_FM_RATIO1";
    constexpr char SYN_OSC_H_FM_DEPTH1[] = "SYN_OSC_H_FM_DEPTH1";
    constexpr char SYN_OSC_H_FM_RATIO2[] = "SYN_OSC_H_FM_RATIO2";
    constexpr char SYN_OSC_H_FM_DEPTH2[] = "SYN_OSC_H_FM_DEPTH2";
    constexpr char SYN_OSC_H_FM_FB[] = "SYN_OSC_H_FM_FB";
    constexpr char SYN_OSC_H_FM_STRIKE[] = "SYN_OSC_H_FM_STRIKE";
    constexpr char SYN_OSC_H_FM_AGE[] = "SYN_OSC_H_FM_AGE";
    constexpr char SYN_OSC_H_FM_RUST[] = "SYN_OSC_H_FM_RUST";
    constexpr char SYN_OSC_H_FM_GALE[] = "SYN_OSC_H_FM_GALE";
    constexpr char SYN_OSC_H_FM_BEND[] = "SYN_OSC_H_FM_BEND";
    constexpr char SYN_OSC_H_FM_STORM[] = "SYN_OSC_H_FM_STORM";
    constexpr char SYN_OSC_H_GEODE_POSITION[] = "SYN_OSC_H_GEODE_POSITION";
    constexpr char SYN_OSC_H_GEODE_FOSSIL[] = "SYN_OSC_H_GEODE_FOSSIL";
    constexpr char SYN_OSC_H_GEODE_CREEP[] = "SYN_OSC_H_GEODE_CREEP";
    constexpr char SYN_OSC_H_GEODE_SILT[] = "SYN_OSC_H_GEODE_SILT";
    constexpr char SYN_OSC_H_GEODE_FORMANT[] = "SYN_OSC_H_GEODE_FORMANT";
    constexpr char SYN_OSC_H_GEODE_CUT[] = "SYN_OSC_H_GEODE_CUT";
    constexpr char SYN_OSC_H_GEODE_SIEVE[] = "SYN_OSC_H_GEODE_SIEVE";
    constexpr char SYN_OSC_H_GEODE_DISTILL[] = "SYN_OSC_H_GEODE_DISTILL";
    constexpr char SYN_OSC_H_GEODE_HAZE[] = "SYN_OSC_H_GEODE_HAZE";
    constexpr char SYN_OSC_H_GEODE_FRACTURE[] = "SYN_OSC_H_GEODE_FRACTURE";
    constexpr char SYN_OSC_H_GEODE_TILT[] = "SYN_OSC_H_GEODE_TILT";
    constexpr char SYN_OSC_H_GEODE_QUALITY[] = "SYN_OSC_H_GEODE_QUALITY";
    constexpr char SYN_OSC_H_GEODE_FKEEP[] = "SYN_OSC_H_GEODE_FKEEP";
    constexpr char SYN_OSC_H_GEODE_LOOP[] = "SYN_OSC_H_GEODE_LOOP";
    constexpr char SYN_OSC_H_GEODE_BEDROCK[] = "SYN_OSC_H_GEODE_BEDROCK";
    constexpr char SYN_OSC_H_GEODE_SHAPE_TARGET[] = "SYN_OSC_H_GEODE_SHAPE_TARGET";
    constexpr char SYN_OSC_H_GEODE_CUT_MODE[] = "SYN_OSC_H_GEODE_CUT_MODE";
    constexpr char SYN_OSC_H_GEODE_DRIVE_MODE[] = "SYN_OSC_H_GEODE_DRIVE_MODE";
    constexpr char SYN_OSC_H_GEODE_SIEVE_MODE[] = "SYN_OSC_H_GEODE_SIEVE_MODE";
    constexpr char SYN_OSC_H_HARM_MODE[] = "SYN_OSC_H_HARM_MODE";
    constexpr char SYN_OSC_H_HARM_SCULPT[] = "SYN_OSC_H_HARM_SCULPT";
    constexpr char SYN_OSC_H_HARM_HUE[] = "SYN_OSC_H_HARM_HUE";
    constexpr char SYN_OSC_H_HARM_COUNT[] = "SYN_OSC_H_HARM_COUNT";
    constexpr char SYN_OSC_H_HARM_LEAN[] = "SYN_OSC_H_HARM_LEAN";
    constexpr char SYN_OSC_H_HARM_FAN[] = "SYN_OSC_H_HARM_FAN";
    constexpr char SYN_OSC_H_HARM_GRIT[] = "SYN_OSC_H_HARM_GRIT";
    constexpr char SYN_OSC_H_HARM_BRAID[] = "SYN_OSC_H_HARM_BRAID";
    constexpr char SYN_OSC_H_HARM_CARVE[] = "SYN_OSC_H_HARM_CARVE";
    constexpr char SYN_OSC_H_HARM_CHURN[] = "SYN_OSC_H_HARM_CHURN";
    constexpr char SYN_OSC_H_HARM_ROOT[] = "SYN_OSC_H_HARM_ROOT";
    constexpr char SYN_OSC_H_HARM_SHINE[] = "SYN_OSC_H_HARM_SHINE";
    constexpr char SYN_OSC_H_HARM_WILT[] = "SYN_OSC_H_HARM_WILT";
    constexpr char SYN_OSC_H_HARM_FIZZ[] = "SYN_OSC_H_HARM_FIZZ";
    constexpr char SYN_OSC_H_HARM_TABLE[] = "SYN_OSC_H_HARM_TABLE";
    constexpr char SYN_OSC_H_COARSE[] = "SYN_OSC_H_COARSE";
    constexpr char SYN_OSC_H_SUB_RANGE[] = "SYN_OSC_H_SUB_RANGE";
    constexpr char SYN_OSC_H_SUB_FORM[] = "SYN_OSC_H_SUB_FORM";
    constexpr char SYN_OSC_H_SUB_WEIGHT[] = "SYN_OSC_H_SUB_WEIGHT";
    constexpr char SYN_OSC_H_SUB_HEAT[] = "SYN_OSC_H_SUB_HEAT";
    constexpr char SYN_OSC_H_MODAL_FAMILY[] = "SYN_OSC_H_MODAL_FAMILY";
    constexpr char SYN_OSC_H_MODAL_FORM[] = "SYN_OSC_H_MODAL_FORM";
    constexpr char SYN_OSC_H_MODAL_SOURCE[] = "SYN_OSC_H_MODAL_SOURCE";
    constexpr char SYN_OSC_H_MODAL_HARD[] = "SYN_OSC_H_MODAL_HARD";
    constexpr char SYN_OSC_H_MODAL_POS[] = "SYN_OSC_H_MODAL_POS";
    constexpr char SYN_OSC_H_MODAL_DECAY[] = "SYN_OSC_H_MODAL_DECAY";
    constexpr char SYN_OSC_H_MODAL_MATERIAL[] = "SYN_OSC_H_MODAL_MATERIAL";
    constexpr char SYN_OSC_H_MODAL_BREATH[] = "SYN_OSC_H_MODAL_BREATH";
    constexpr char SYN_OSC_H_MODAL_STRETCH[] = "SYN_OSC_H_MODAL_STRETCH";
    constexpr char SYN_OSC_H_MODAL_BLOOM[] = "SYN_OSC_H_MODAL_BLOOM";
    constexpr char SYN_OSC_H_MODAL_HALO[] = "SYN_OSC_H_MODAL_HALO";
    constexpr char SYN_OSC_H_MODAL_AGE[] = "SYN_OSC_H_MODAL_AGE";
    constexpr char SYN_OSC_H_MODAL_BODY[] = "SYN_OSC_H_MODAL_BODY";
    constexpr char SYN_OSC_H_ORG_INST[] = "SYN_OSC_H_ORG_INST";
    constexpr char SYN_OSC_H_ORG_ARTIC[] = "SYN_OSC_H_ORG_ARTIC";
    constexpr char SYN_OSC_H_ORG_DYNAMICS[] = "SYN_OSC_H_ORG_DYNAMICS";
    constexpr char SYN_OSC_H_ORG_TONE[] = "SYN_OSC_H_ORG_TONE";
    constexpr char SYN_OSC_H_ORG_BODY[] = "SYN_OSC_H_ORG_BODY";
    constexpr char SYN_OSC_H_ORG_ATTACK[] = "SYN_OSC_H_ORG_ATTACK";
    constexpr char SYN_OSC_H_ORG_HUMAN[] = "SYN_OSC_H_ORG_HUMAN";
    constexpr char SYN_OSC_H_ORG_RELEASE[] = "SYN_OSC_H_ORG_RELEASE";
    constexpr char SYN_OSC_H_ORG_NOISE[] = "SYN_OSC_H_ORG_NOISE";
    ...
    constexpr char SYN_OSC_H_WSLOT2_MODE[] = "SYN_OSC_H_WSLOT2_MODE";
    constexpr char SYN_OSC_H_WSLOT2_SRC[] = "SYN_OSC_H_WSLOT2_SRC";
    constexpr char SYN_OSC_H_WSLOT2_DEPTH[] = "SYN_OSC_H_WSLOT2_DEPTH";
    constexpr char SYN_OSC_H_WSLOT3_MODE[] = "SYN_OSC_H_WSLOT3_MODE";
    constexpr char SYN_OSC_H_WSLOT3_SRC[] = "SYN_OSC_H_WSLOT3_SRC";
    constexpr char SYN_OSC_H_WSLOT3_DEPTH[] = "SYN_OSC_H_WSLOT3_DEPTH";
    constexpr char SYN_OSC_H_WSLOT4_MODE[] = "SYN_OSC_H_WSLOT4_MODE";
    constexpr char SYN_OSC_H_WSLOT4_SRC[] = "SYN_OSC_H_WSLOT4_SRC";
    constexpr char SYN_OSC_H_WSLOT4_DEPTH[] = "SYN_OSC_H_WSLOT4_DEPTH";
    constexpr char SYN_RVB_SRC_E[] = "SYN_RVB_SRC_E"; constexpr char SYN_RVB_SRC_F[] = "SYN_RVB_SRC_F";
    constexpr char SYN_RVB_SRC_G[] = "SYN_RVB_SRC_G"; constexpr char SYN_RVB_SRC_H[] = "SYN_RVB_SRC_H";
    constexpr char SYN_DLY_SRC_E[] = "SYN_DLY_SRC_E"; constexpr char SYN_DLY_SRC_F[] = "SYN_DLY_SRC_F";
    constexpr char SYN_DLY_SRC_G[] = "SYN_DLY_SRC_G"; constexpr char SYN_DLY_SRC_H[] = "SYN_DLY_SRC_H";
    constexpr char SYN_DST_SRC_E[] = "SYN_DST_SRC_E"; constexpr char SYN_DST_SRC_F[] = "SYN_DST_SRC_F";
