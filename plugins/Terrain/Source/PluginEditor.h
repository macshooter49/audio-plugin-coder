...
class TerrainAudioProcessorEditor;   // fb516 -- the thin shell (defined below)
...
public:
    ...
    void attach (TerrainAudioProcessorEditor* shell);
    void detach();
    ...
    TerrainAudioProcessorEditor* currentShell() const { return shell_; }   // fb520
...
private:
    ...
    static constexpr int kOrgRelayKnobs = 18;   // tp105: + VIBRATO VIBRATE VIBDELAY VCURVE TUNING · tp114: + START
    ...
    TerrainAudioProcessorEditor* shell_ = nullptr;         // fb516 -- null while parked
    ...
    tw::ResynthEngine geodeDispEng_[4];
...
{
public:
    explicit TerrainAudioProcessorEditor (TerrainAudioProcessor&);
...
private:
    ...
    {
        explicit ShowingWatch (TerrainAudioProcessorEditor& s)
        ...
        TerrainAudioProcessorEditor& shell;
    };
