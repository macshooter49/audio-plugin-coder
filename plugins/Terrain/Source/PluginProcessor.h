...
public:
    ...
    // calling TerrainAudioProcessor::bakeSeamlessNoiseLoop is a one-line change and is
    ...
    float modVizNote () const noexcept { return noteVis_.load (std::memory_order_relaxed); }   // fb555
