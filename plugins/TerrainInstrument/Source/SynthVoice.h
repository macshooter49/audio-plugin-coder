...
namespace tw
{
    ...
    public:
        ...
        struct WtDisp { float frame, warpAmt, warp2Amt, foldAmt, stretch; int warpMode, warp2Mode, foldShape; };
        WtDisp getWtDisplay (int osc) const noexcept
        {
            switch (osc)
            {
                case 1:  return { framePosB_, warpAmountB_, warp2AmountB_, foldAmountB_, 0.0f, warpModeB_, warp2ModeB_, foldShapeB_ };
                case 2:  return { framePosC_, warpAmountC_, warp2AmountC_, foldAmountC_, 0.0f, warpModeC_, warp2ModeC_, foldShapeC_ };
                case 3:  return { framePosD_, warpAmountD_, warp2AmountD_, foldAmountD_, 0.0f, warpModeD_, warp2ModeD_, foldShapeD_ };
                default: return { framePos_,  warpAmount_,  warp2AmountA_, foldAmountA_, 0.0f, warpMode_,  warp2ModeA_, foldShapeA_ };
            }
        }
    ...
    public:
                              ...
                              int startSample, int numSamples) override
        {
            ...
            if (currentWavetable_ != nullptr)
            {
                ...
                if (fpA != lastFpA_ || currentMipLevelA_ != lastMipA_ || currentWavetable_ != lastWtA_ || epA != lastEpochA_)
                {
                    ...
                    blendValidA_ = true;
                    lastFpA_ = fpA; lastMipA_ = currentMipLevelA_; lastWtA_ = currentWavetable_; lastEpochA_ = epA;
                }
            }
            if (currentWavetableB_ != nullptr)
            {
                ...
                if (fpB != lastFpB_ || currentMipLevelB_ != lastMipB_ || currentWavetableB_ != lastWtB_ || epB != lastEpochB_)
                {
                    ...
                    blendValidB_ = true;
                    lastFpB_ = fpB; lastMipB_ = currentMipLevelB_; lastWtB_ = currentWavetableB_; lastEpochB_ = epB;
                }
            }
            if (currentWavetableC_ != nullptr)
            {
                ...
                if (fpC != lastFpC_ || currentMipLevelC_ != lastMipC_ || currentWavetableC_ != lastWtC_ || epC != lastEpochC_)
                {
                    ...
                    blendValidC_ = true;
                    lastFpC_ = fpC; lastMipC_ = currentMipLevelC_; lastWtC_ = currentWavetableC_; lastEpochC_ = epC;
                }
            }
            if (currentWavetableD_ != nullptr)
            {
                ...
                if (fpD != lastFpD_ || currentMipLevelD_ != lastMipD_ || currentWavetableD_ != lastWtD_ || epD != lastEpochD_)
                {
                    ...
                    blendValidD_ = true;
                    lastFpD_ = fpD; lastMipD_ = currentMipLevelD_; lastWtD_ = currentWavetableD_; lastEpochD_ = epD;
                }
            }
...
// ── BLEND MODES: per-carrier read-phase offset from the 4 cross-osc warp slots. PD = modulator
    ...
    private:
        ...
        float lastFpA_ = -2.0f; int lastMipA_ = -2; int lastEpochA_ = -1;
        float lastFpB_ = -2.0f; int lastMipB_ = -2; int lastEpochB_ = -1;
        ...
        float  lastFpC_ = -2.0f; int lastMipC_ = -2; int lastEpochC_ = -1;
        ...
        float  lastFpD_ = -2.0f; int lastMipD_ = -2; int lastEpochD_ = -1;
