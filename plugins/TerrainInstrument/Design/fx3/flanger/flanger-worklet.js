...
const SPEC = [
  ...
  [ // Jet
    ...
    S(+1, 1.00, 0.95, 0.15, 1, 0.6, 0.5, 0.70, 1, 1, 1, 1.00, 1.53, 0.985, +1, F_TWINTAP, 0)],
  [ // BBD
    S(+1, 1.00, 0.70, 0, 1, 0.9, 0.5, 0.66, 1.00, 1.00, 1.00, 1.00, 0, 0.97, +1, F_BBD, 0),
    S(+1, 1.00, 0.90, 0, 1, 0.8, 0.5, 0.70, 1.60, 0.45, 1.60, 1.00, 0, 0.97, +1, F_BBD, 0),
    S(+1, 1.00, 0.40, 0, 1, 1.0, 0.5, 0.62, 0.40, 1.10, 1.00, 1.10, 0, 0.97, +1, F_BBD, 0),
    S(+1, 1.00, 0.70, 0, 1, 1.0, 0.5, 0.60, 0.95, 2.10, 0.25, 1.00, 0, 0.97, +1, F_BBD, 0),
    S(+1, 1.00, 0.70, 0, 1, 0.6, 0.5, 0.66, 1.00, 1.00, 1.00, 1.00, 0, 0.97, +1, F_BBD | F_MATRIX, 0),
    S(+1, 0.80, 1.10, 0, 1, 0.9, 0.5, 0.66, 1.75, 0.85, 1.20, 0.45, 0, 0.97, +1, F_BBD, 0),
    S(+1, 1.10, 0.55, 0, 1, 1.1, 0.5, 0.66, 0.62, 1.20, 0.90, 2.00, 0, 0.97, +1, F_BBD, 0),
    S(-1, 1.00, 0.60, 0, 1, 1.0, 0.5, 0.40, 0.85, 1.55, 0.50, 1.00, 0, 0.97, +1, F_BBD, 0)],
  [ // Endless
    S(+1, 1.00, 1.00, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.95, +1, 0, 0),
    S(+1, 1.00, 1.00, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.95, -1, 0, 0),
    S(+1, 1.55, 1.00, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.55, 0, 0.95, +1, 0, 0),
    S(+1, 1.55, 1.00, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.55, 0, 0.95, -1, 0, 0),
    S(+1, 1.00, 1.00, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.95, +1, F_COUNTER_LR, 0),
    S(+1, 1.00, 0.95, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.00, 2.00, 0.90, +1, F_TWINTAP, 0),
    S(-1, 1.00, 1.00, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.95, +1, 0, 0),
    S(+1, 0.75, 1.15, 0, 1, 0.4, 0.5, 0.70, 1, 1, 1, 0.60, 0, 0.95, +1, 0, 0)],
  [ // Envelope
    S(+1, 1.00, 0.95, 0, 1.00, 0.4, 0.5, 0.70, 1, 1, 1.00, 1.00, 0, 0.95, +1, 0, 0),
    S(+1, 1.00, 0.95, 0, 1.00, 0.4, 0.5, 0.70, 1, 1, 1.00, 1.00, 0, 0.95, -1, 0, 0),
    S(+1, 1.10, 0.95, 0, 2.20, 0.4, 0.5, 0.70, 1, 1, 0.12, 1.00, 0, 0.95, +1, 0, 0),
    S(+1, 1.00, 0.95, 0, 0.55, 0.4, 0.5, 0.70, 1, 1, 6.00, 1.00, 0, 0.95, +1, 0, 0),
    S(-1, 1.00, 0.95, 0, 1.00, 0.5, 0.5, 0.70, 1, 1, 1.00, 1.00, 0, 0.85, +1, F_DUCK_ZERO, 0),
    S(+1, 1.00, 0.95, 0, 1.00, 0.4, 0.5, 0.70, 1, 1, 0.50, 1.00, 0, 0.95, +1, F_HOLD, 0),
    S(+1, 1.00, 0.95, 0, 1.00, 0.4, 0.5, 0.70, 1, 1, 1.00, 1.00, 0, 0.95, +1, F_SPLIT_ENV, 0),
    S(+1, 1.70, 0.95, 0, 1.00, 0.4, 0.5, 0.70, 1, 1, 1.00, 1.20, 0, 0.95, +1, 0, 0)],
  [ // Step
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 0),
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 1),
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 2),
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 3),
    S(+1, 1.15, 0.85, 0, 1, 0.3, 0.5, 0.66, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 4),
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 5),
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, F_COUNTER_LR, 6),
    S(+1, 1.00, 0.95, 0, 1, 0.3, 0.5, 0.70, 1, 1, 1, 1.00, 0, 0.98, +1, 0, 7)]
];
...
class TerrainFlanger extends AudioWorkletProcessor {
  ...
  cook (c, p) {
    ...
    this.combT = this.type === 3 ? (0.05 + 0.95 * this.depT) : 1;     // Endless: Depth IS notch depth
