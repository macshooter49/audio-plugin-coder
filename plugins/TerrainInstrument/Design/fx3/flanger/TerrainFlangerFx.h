...
private:
    ...
    static constexpr CharSpec kTable_[kNumTypes][kNumChars] =
        ...
        {   // ---- Tape Zero ----
          { -1.0f, 1.00f, 1.00f,+0.00f, 1.35f, 1.0f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, 0               , 0 },  // Sub
          { +1.0f, 1.00f, 1.00f,+0.00f, 1.35f, 1.0f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, 0               , 0 },  // Add
          { -1.0f, 1.00f, 0.72f,+0.15f, 1.15f, 2.4f, 0.45f, 0.60f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, +1, 0               , 0 },  // Worn Deck
          { -1.0f, 1.00f, 1.00f,+0.00f, 1.50f, 1.2f, 0.18f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, 0               , 0 },  // Servo
          { -1.0f, 1.00f, 1.00f,+0.00f, 1.35f, 1.0f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, F_COUNTER_LR    , 0 },  // Wide Zero
          { -1.0f, 1.18f, 1.00f,+0.00f, 2.00f, 1.0f, 0.55f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, 0               , 0 },  // Deep Zero
          { -1.0f, 1.00f, 0.90f,+0.05f, 1.35f, 1.8f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, F_BIASDRIFT     , 0 },  // Drifting Zero
          { -1.0f, 1.00f, 1.00f,+0.00f, 1.35f, 1.0f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, F_COUNTER       , 0 },  // Counter Reel
        },
        {   // ---- Jet ----
        ...
        {   // ---- BBD ----
          { +1.0f, 1.00f, 0.70f,+0.00f, 1.00f, 0.9f, 0.50f, 0.66f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Mistress
          { +1.0f, 1.00f, 0.90f,+0.00f, 1.00f, 0.8f, 0.50f, 0.70f, 1.60f, 0.45f, 1.60f, 1.00f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Deluxe
          { +1.0f, 1.00f, 0.40f,+0.00f, 1.00f, 1.0f, 0.50f, 0.62f, 0.40f, 1.10f, 1.00f, 1.10f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Dark Bucket
          { +1.0f, 1.00f, 0.70f,+0.00f, 1.00f, 1.0f, 0.50f, 0.60f, 0.95f, 2.10f, 0.25f, 1.00f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Squash
          { +1.0f, 1.00f, 0.70f,+0.00f, 1.00f, 0.6f, 0.50f, 0.66f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.97f, +1, F_BBD|F_MATRIX  , 0 },  // Matrix
          { +1.0f, 0.80f, 1.10f,+0.00f, 1.00f, 0.9f, 0.50f, 0.66f, 1.75f, 0.85f, 1.20f, 0.45f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Short Bucket
          { +1.0f, 1.10f, 0.55f,+0.00f, 1.00f, 1.1f, 0.50f, 0.66f, 0.62f, 1.20f, 0.90f, 2.00f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Long Bucket
          { -1.0f, 1.00f, 0.60f,+0.00f, 1.00f, 1.0f, 0.50f, 0.40f, 0.85f, 1.55f, 0.50f, 1.00f, 0.00f, 0.97f, +1, F_BBD           , 0 },  // Grind
        },
        {   // ---- Endless ----
          { +1.0f, 1.00f, 1.00f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, +1, 0               , 0 },  // Rise
          { +1.0f, 1.00f, 1.00f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, -1, 0               , 0 },  // Fall
          { +1.0f, 1.55f, 1.00f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.55f, 0.00f, 0.95f, +1, 0               , 0 },  // Rise Deep
          { +1.0f, 1.55f, 1.00f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.55f, 0.00f, 0.95f, -1, 0               , 0 },  // Fall Deep
          { +1.0f, 1.00f, 1.00f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, +1, F_COUNTER_LR    , 0 },  // Double Helix
          { +1.0f, 1.00f, 0.95f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 2.00f, 0.90f, +1, F_TWINTAP       , 0 },  // Stacked Rise
          { -1.0f, 1.00f, 1.00f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, +1, 0               , 0 },  // Soft Rise
          { +1.0f, 0.75f, 1.15f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 0.60f, 0.00f, 0.95f, +1, 0               , 0 },  // Tight Rise
        },
        {   // ---- Envelope ----
          { +1.0f, 1.00f, 0.95f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, +1, 0               , 0 },  // Up
          { +1.0f, 1.00f, 0.95f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, -1, 0               , 0 },  // Down
          { +1.0f, 1.10f, 0.95f,+0.00f, 2.20f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 0.12f, 1.00f, 0.00f, 0.95f, +1, 0               , 0 },  // Snap
          { +1.0f, 1.00f, 0.95f,+0.00f, 0.55f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 6.00f, 1.00f, 0.00f, 0.95f, +1, 0               , 0 },  // Slow Swell
          { -1.0f, 1.00f, 0.95f,+0.00f, 1.00f, 0.5f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.85f, +1, F_DUCK_ZERO     , 0 },  // Duck Zero
          { +1.0f, 1.00f, 0.95f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 0.50f, 1.00f, 0.00f, 0.95f, +1, F_HOLD          , 0 },  // Hold
          { +1.0f, 1.00f, 0.95f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.00f, 0.00f, 0.95f, +1, F_SPLIT_ENV     , 0 },  // Wide Touch
          { +1.0f, 1.70f, 0.95f,+0.00f, 1.00f, 0.4f, 0.50f, 0.70f, 1.00f, 1.00f, 1.00f, 1.20f, 0.00f, 0.95f, +1, 0               , 0 },  // Deep Touch
        },
        {   // ---- Step ----
