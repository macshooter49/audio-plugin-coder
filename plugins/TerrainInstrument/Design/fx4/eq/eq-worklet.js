...
const CSPEC = [
 [ C('Clean',       O,O,O, N4, 700, 1,1, 0,0,0),
   C('Tight',       [2.6,2.6,2.6,2.6],O,O, N4, 700, 1,1, 0,0,0),
   C('Broad',       [0.35,0.35,0.35,0.35],O,O, N4, 700, 1,1, 0,0,0),
   C('Steep',       O,O,O, [5,-1,-1,5], 700, 1,1, 0,0,0),
   C('Carve',       O,O,O, N4, 700, 3.5,1, 0,0,0),
   C('Deep Pivot',  O,O,O, N4, 150, 1,1, 0,0,0),
   C('Bright Pivot',O,O,O, N4, 3000, 1,1, 0,0,0),
   C('Four Bells',  O,O,O, [0,-1,-1,0], 700, 1,1, 0,0,0) ],
 [ C('Console',     O,O,O, N4, 700, 1,1, 1,1,0),
   C('Big Knob',    [1,0.5,0.5,1],O,O, N4, 700, 1,1, 1,1,0),
   C('Forward',     [1,2.2,2.4,1],[1,1.5,1.2,1],O, N4, 700, 1,1, 1,1,0),
   C('Iron Top',    [1,1,1,1.9],[1,1,1,0.78],[1,1,1,1.1], N4, 700, 1,1, 1.6,1,0),
   C('Sub Iron',    [1.6,1,1,1],[0.42,1,1,1],O, N4, 700, 1,1, 1.3,1,0),
   C('Steep Iron',  O,O,O, [5,-1,-1,5], 700, 1,1, 1,1,0),
   C('Full Swing',  O,O,O, N4, 700, 1,1, 0.45,0,0),
   C('Mid Rise',    [1,0.65,1,1],[1,1.9,1,1],[1,1.25,1,1], N4, 700, 1,1, 1,1,0) ],
 [ C('Proportional',O,O,O, N4, 700, 1,1, 0,0,0),
   C('Lasers',      [1.6,1.6,1.6,1.6],O,O, N4, 700, 1,1, 1.2,0,0),
   C('Gentle',      [0.7,0.7,0.7,0.7],O,O, N4, 700, 1,1, -0.55,0,0),
   C('Floor Lift',  [2.2,2.2,2.2,2.2],O,O, N4, 700, 1,1, -0.30,0,0),
   C('Boost Only',  O,O,O, N4, 700, 1,1, 0,1,0),
   C('Cut Only',    O,O,O, N4, 700, 1,1, 0,2,0),
   C('Shelf Ride',  [1.4,1,1,1.4],O,O, N4, 700, 1,1, 0,0,1),
   C('Runaway',     [2.2,2.2,2.2,2.2],O,O, N4, 700, 1,1, 2.0,0,0) ],
 [ C('Program',     O,O,O, N4, 700, 1,1, 2.2,0,0),
   C('Close Dip',   O,O,O, N4, 700, 1,1, 1.4,0,0),
   C('Far Dip',     O,O,O, N4, 700, 1,1, 4.4,0,0),
   C('Both Ends',   O,O,O, N4, 700, 1,1, 2.2,1,0),
   C('Bell Top',    [1,1,1,0.70],O,O, [-1,-1,-1,0], 700, 1,1, 2.2,0,0),
   C('Slow Top',    O,O,O, [-1,-1,-1,4], 700, 1,1, 2.2,0,0),
   C('Deep Atten',  O,O,O, N4, 700, 1,1.45, 2.2,0,0),
   C('Modern',      O,O,O, N4, 700, 1,1, 2.2,2,0) ],
 [ C('Silky',       O,O,O, N4, 700, 1,1, 1.0,22,0),
   C('Very Wide',   [0.55,0.55,0.55,0.55],O,O, N4, 700, 1,1, 1.0,22,0),
   C('Two Shelves', O,O,O, [-1,1,-1,-1], 700, 1,1, 1.0,22,0),
   C('Stacked',     O,O,O, N4, 700, 1,1, -1.0,22,0),
   C('Deep Reach',  [1,1,1,1.5],O,O, N4, 700, 1,1, -2.0,22,0),
   C('Soft Knee',   O,O,O, N4, 700, 1,1, 1.0,12,0),
   C('Hard Knee',   O,O,O, N4, 700, 1,1, 1.0,90,0),
   C('Bell Air',    [1,1,1,0.50],O,O, [-1,-1,-1,0], 700, 1,1, 1.0,22,0) ],
 [ C('Program Ride',O,O,O, N4, 700, 1,1, 1.0,0,14),
   C('Fast',        O,O,O, N4, 700, 1,1, 0.22,0,14),
   C('Slow',        O,O,O, N4, 700, 1,1, 5.0,0,14),
   C('Wideband',    O,O,O, N4, 700, 1,1, 1.0,2,14),
   C('Inverted',    O,O,O, N4, 700, 1,1, 1.0,1,14),
   C('Hard Window', O,O,O, N4, 700, 1,1, 1.0,0,2.5),
   C('Soft Window', O,O,O, N4, 700, 1,1, 1.0,0,34),
   C('Peak Hold',   O,O,O, N4, 700, 1,1, 1.0,3,14) ],
 [ C('Resonator',   O,O,O, N4, 700, 1,1, -18,1.0,0),
   C('Razor',       [2.5,2.5,2.5,2.5],O,O, N4, 700, 1,1, -12,1.0,0),
   C('Triple Notch',O,[1,2.0,4.0,1],O, N4, 700, 1,1, -14,1.0,0),
   C('Gain Ring',   O,O,O, N4, 700, 1,1, -18,2.6,0),
   C('Shallow',     O,O,O, N4, 700, 1,1, -90,1.0,0),
   C('Telephone',   O,[2.5,1,1,0.35],O, [0,-1,-1,0], 700, 1,1, -18,1.0,0),
   C('Sub Kill',    [3,1,1,1],[0.35,1,1,1],O, N4, 700, 1,1, -10,1.0,0),
   C('Metal',       [4,4,4,4],O,O, N4, 700, 1,1, -18,1.8,0) ]
];
...
class TerrainEq extends AudioWorkletProcessor {
  ...
  process(inputs, outputs) {
    ...
    while (i < n) {
      if (this.ctr <= 0) {
        for (let k = 0; k < 11; ++k) this.sm[k] += this.k[k] * (this.tg[k] - this.sm[k]);
