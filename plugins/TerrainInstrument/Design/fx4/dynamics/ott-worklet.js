...
const TSPEC = [
  ...
  { xlo: 1, xhi: 0.72, n: 3, tdn: [-40, -31, -40], tup: [-45, -37, -42], sdn: [0.90, 0.907, 1.0], sup: [0.8, 0.8, 0.9],  mk: [12, 14, 15], atk: [2.8, 1.4, 0.35], rel: [40, 28, 8],   knee: 2,  det: 0, clip: 999, lowUpOff: 0, lowMono: 0 },
...
const CSPEC = [
  ...
  [{}, { xhiMul: 1.6 }, { xhiMul: 0.6 }, { tupOff: -10, knee: 0, upCap: 10, clip: 4 },
  ...
  [{}, { upMul: 1.15, tupOff: 6, upCap: 36 }, { rMul: 3 }, { aMul: 0.25, rMul: 0.25 },
   { upCap: 12 }, { hiTimeMul: 0.3, upMul: 1.2, tupOff: 4, upCap: 30, xhiMul: 0.7 },
   { spread: 2.6, lowMono: 1, deepRel: 1 }, { upMul: 1.12, tupOff: 10, upCap: 36 }],
