...
#
#    bash Tests/fb602_gates.sh          # from plugins/TerrainInstrument
#
...
echo "══ fb602 GATES ══  installed AU: $(ls -l ~/Library/Audio/Plug-Ins/Components/'Terrain Instrument.component'/Contents/MacOS/ 2>/dev/null | tail -1 | awk '{print $6,$7,$8}')"
echo
