...
//==============================================================================
TerrainFXAudioProcessorEditor::TerrainFXAudioProcessorEditor (TerrainFXAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    webView = std::make_unique<juce::WebBrowserComponent>(
        juce::WebBrowserComponent::Options()
            ...
            // ⚠️ fb605 — <userAppData>/"Waves Crate"/"Terrain"/PluginSettings.json below is an
            // ADDRESS, not the product name. That folder already holds the owner's settings (and
            // the synth's InstrumentSettings.json beside them). The product is "Terrain FX" now;
            // this path stays exactly where his file already is.
...
TerrainFXAudioProcessorEditor::~TerrainFXAudioProcessorEditor()
{
    stopTimer();
}

//==============================================================================
void TerrainFXAudioProcessorEditor::timerCallback()
{
    ...
    scopeData << "[";
    for (int i = 0; i < TerrainFXAudioProcessor::SCOPE_SIZE; ++i)
    {
        if (i > 0) scopeData << ",";
...
//==============================================================================
void TerrainFXAudioProcessorEditor::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void TerrainFXAudioProcessorEditor::resized()
{
...
//==============================================================================
void TerrainFXAudioProcessorEditor::CaptureDragStrip::paint (juce::Graphics& g)
{
...
void TerrainFXAudioProcessorEditor::CaptureDragStrip::mouseDown (const juce::MouseEvent&)
{
    mouseWasDown = true;
    isDragging = false;
...
void TerrainFXAudioProcessorEditor::CaptureDragStrip::mouseDrag (const juce::MouseEvent& e)
{
...
void TerrainFXAudioProcessorEditor::CaptureDragStrip::mouseUp (const juce::MouseEvent&)
{
...
//==============================================================================
std::optional<juce::WebBrowserComponent::Resource> TerrainFXAudioProcessorEditor::getResource (const juce::String& url)
{
