...
//==============================================================================
class TerrainFXAudioProcessor  : public juce::AudioProcessor
{
public:
    TerrainFXAudioProcessor();
    ~TerrainFXAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TerrainFXAudioProcessor)
};
