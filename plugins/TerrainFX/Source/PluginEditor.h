...
class TerrainFXAudioProcessorEditor  : public juce::AudioProcessorEditor,
                                     private juce::Timer
{
public:
    TerrainFXAudioProcessorEditor (TerrainFXAudioProcessor&);
    ~TerrainFXAudioProcessorEditor() override;
...
private:
    ...
    TerrainFXAudioProcessor& audioProcessor;
    ...
    {
    public:
        CaptureDragStrip (TerrainFXAudioProcessor& p) : processor (p) {}
    ...
    private:
        TerrainFXAudioProcessor& processor;
        int state = 0;
        float avail = 0.f;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TerrainFXAudioProcessorEditor)
};
