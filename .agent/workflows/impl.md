...
**Execute Skill:**
Load and execute `...agent\skills\skill_implementation\SKILL.md`
...
$phaseIssues = Get-Content ...agent\troubleshooting\known-issues.yaml | 
    ConvertFrom-Yaml | 
...
### **2. As Known Issues** (`...agent/troubleshooting/resolutions/`)
