...
**Framework Routing:**
- **WebView:** Use templates in `..kilocode/templates/webview/` and run WebView validation scripts.
- **Visage:** Use templates in `..kilocode/templates/visage/`. Do NOT generate HTML.
